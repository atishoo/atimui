  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      var c = function(e, t, n) {
        ...
        const b = f ? r : h ? r[t] : (r[t] || {}).prototype;
        for (u in (f && (n = t), n))
          ((d = !p && b && void 0 !== b[u]) && s(y, u)) ||
            ((l = d ? b[u] : n[u]),
            (y[u] =
      ...
      (function(t) {
        ...
        const i = (function() {
          ...
          function f(e, t) {
            ...
            return (
              (function(e, t) {
                ...
                if (typeof i === 'number' && i > -1 && i <= n) for (; ++r < i; ) t(e[r], r, e);
                else d(e, t);
              })(e, (n, i) => {
                r = t(r, n, i, e);
              }),
          ...
          return (function t(n) {
            ...
            const C = a && o.java ? 'JavaPackage' : l(o.java);

            const _ = a ? 'Object' : 'RuntimeObject';

            const T = /\bJava/.test(C) && o.java;
            ...
            let D = M && P && typeof P.version === 'function' && P.version();
            ...
            if (
              ...
              j == 'IE' && /\blike iPhone OS\b/.test(n)
                ? ((V = (v = t(n.replace(/like iPhone OS/, ''))).manufacturer), (N = v.product))
                : /^iP/.test(N)
                  ? (j || (j = 'Safari'),
                    (U = `iOS${
                  ...
                  : j != 'Konqueror' || /buntu/i.test(U)
                    ? (V &&
                        V != 'Google' &&
                        ((/Chrome/.test(j) && !/\bMobile Safari\b/i.test(n)) ||
                          /\bVita\b/.test(N))) ||
                      (/\bAndroid\b/.test(U) && /^Chrome/.test(j) && /\bVersion\//i.test(n))
                      ...
                      : j == 'Silk'
                        ...
                        : j == 'PaleMoon' && (v = /\bFirefox\/([\d.]+)\b/.exec(n))
                          ? A.push(`identifying as Firefox ${v[1]}`)
                          : j == 'Firefox' && (v = /\b(Mobile|Tablet|TV)\b/i.exec(n))
                            ? (U || (U = 'Firefox OS'), N || (N = v[1]))
                            : !j ||
                              (v = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(j))
                              ? (j &&
                                  !N &&
              ...
              (v =
                ...
                (L = [v]),
              j == 'IE' && (v = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(n) || 0)[1])
                ? ((j += ' Mobile'),
                ...
                : /\bWPDesktop\b/i.test(n)
                  ? ((j = 'IE Mobile'),
                    (U = 'Windows Phone 8.x'),
                    A.unshift('desktop mode'),
                    D || (D = (/\brv:([\d.]+)/.exec(n) || 0)[1]))
                  : j != 'IE' &&
                    L == 'Trident' &&
                    (v = /\brv:([\d.]+)/.exec(n)) &&
                    (j && A.push(`identifying as ${j}${D ? ` ${D}` : ''}`), (j = 'IE'), (D = v[1])),
              M)
            ) {
              if (
                (function(e, t) {
                ...
                if (
                  ...
                  (0, r.default)(o.process) === 'object' &&
                    !o.process.browser &&
                    (v = o.process) &&
                    ((0, r.default)(v.versions) === 'object' &&
                      (typeof v.versions.electron === 'string'
                        ? (A.push(`Node ${v.versions.node}`),
                          (j = 'Electron'),
                          (D = v.versions.electron))
                        : typeof v.versions.nw === 'string' &&
                          (A.push(`Chromium ${D}`, `Node ${v.versions.node}`),
                          (j = 'NW.js'),
                          (D = v.versions.nw))),
                    j ||
                      ((j = 'Node.js'),
                ...
                l((v = o.runtime)) == S
                  ...
                  : l((v = o.phantom)) == _
                    ...
                    : typeof E.documentMode === 'number' && (v = /\bTrident\/(\d+)/i.exec(n))
                      ? ((D = [D, E.documentMode]),
                        (v = +v[1] + 4) != D[1] &&
                          (A.push(`IE ${D[1]} mode`), L && (L[1] = ''), (D[1] = v)),
                        (D = j == 'IE' ? String(D[1].toFixed(1)) : D[0]))
                      : typeof E.documentMode === 'number' &&
                        /^(?:Chrome|Firefox)\b/.test(j) &&
                        (A.push(`masking as ${j} ${D}`),
                        (j = 'IE'),
                        (D = '11.0'),
                        (L = ['Trident']),
                        (U = 'Windows'));
            ...
            if (
              (D &&
                (v =
                  ...
                  /(?:alpha|beta)(?: ?\d)?/i.exec(`${n};${M && c.appMinorVersion}`) ||
                  (/\bMinefield\b/i.test(n) && 'a')) &&
                ((x = /b/i.test(v) ? 'beta' : 'alpha'),
                (D =
                  D.replace(RegExp(`${v}\\+?$`), '') +
                  (x == 'beta' ? k : w) +
                  (/\d+\+?/.exec(v) || ''))),
              ...
              N == 'Xbox 360' && (U = null),
                N == 'Xbox 360' && /\bIEMobile\b/.test(n) && A.unshift('mobile mode');
            else if (
              ...
              if (j == 'IE' && M)
                try {
                  o.external === null && A.unshift('platform preview');
                } catch (e) {
                  A.unshift('embedded');
                }
              else
                (/\bBlackBerry\b/.test(N) || /\bBB10\b/.test(n)) &&
                (v = (RegExp(`${N.replace(/ +/g, ' *')}/([.\\d]+)`, 'i').exec(n) || 0)[1] || D)
                  ? ((U = `${
                      (v = [v, /BB10/.test(n)])[1]
                        ? ((N = null), (V = 'BlackBerry'))
                        : 'Device Software'
                    ...
                    ((M && P) ||
                      ...
                      (j == 'IE' &&
                        ((U && !/^Win/.test(U) && D > 5.5) ||
                          ...
                          (D == 8 && !/\bTrident\b/.test(n))))) &&
                    !i.test((v = t.call(d, `${n.replace(i, '')};`))) &&
                    v.name &&
            ...
            (v = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(n) || 0)[1]) &&
              ...
              j == 'Safari' && v[1].slice(-1) == '+'
                ? ((j = 'WebKit Nightly'), (x = 'alpha'), (D = v[1].slice(0, -1)))
                : (D != v[1] && D != (v[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1])) ||
                  (D = null),
              ...
              L &&
                ...
                A.push(v),
              A.length && (A = [`(${A.join('; ')})`]),
              V && N && N.indexOf(V) < 0 && A.push(`on ${V}`),
              N && A.push((/^on /.test(A[A.length - 1]) ? '' : 'on ') + N),
              U &&
                ((v = / ([\d.+]+)$/.exec(U)),
            ...
            return (
              ...
              B.version && A.unshift(D),
              B.name && A.unshift(j),
              U &&
                j &&
                (U != String(U).split(' ')[0] || (U != j.split(' ')[0] && !N)) &&
                A.push(N ? `(${U})` : `on ${U}`),
              A.length && (B.description = A.join(' ')),
              B
            );
          })();
        })();
    ...
    function(e, t, n) {
      ...
      t.default = function(e, t) {
        ...
        return !t ||
          ((void 0 === t ? 'undefined' : (0, r.default)(t)) !== 'object' && typeof t !== 'function')
          ? e
          : t;
      };
    },
      ...
      (function(e) {
        ...
        (t.getGlobal = i),
          ...
          (t.dataset = function(e, t, n) {
            if (!T(n)) return e.getAttribute(`data-${t}`);
        ...
        t.format = (function() {
          ...
          const t = { yyyy: a, MM: s, dd: c, hh: u, mm: d, ss: l, SSS: p };
          return function(n, r) {
            return (
              (n = new Date(n)),
              isNaN(+n)
        ...
        const k = (t.addEventListener = function(e, t, n) {
          e.addEventListener
        ...
        const P = (t.removeEventListener = function(e, t, n) {
    ...
    function(e, t, n) {
      ...
      (u.deviceTypeMap = ((r = {}),
      (0, s.default)(r, u.DEVICE_TYPE_AUDIO_IN, 'audioIn'),
      (0, s.default)(r, u.DEVICE_TYPE_AUDIO_OUT_CHAT, 'audioOut'),
      (0, s.default)(r, u.DEVICE_TYPE_VIDEO, 'video'),
      r)),
        (u.deviceTypeMap = ((i = {}),
      ...
      const d = {
        getVideoSessionConfig() {
          ...
          const i = void 0 === r ? u.CHAT_VIDEO_FRAME_RATE_NORMAL : r;
      ...
      (t.constantTool = d), (t.constantRtc = l), (t.constantBB = p);
    },
    function(e, t, n) {
      const r = n(55);

      const i = n(36).concat('length', 'prototype');
      t.f =
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, h, m, v, g) {
        ...
        const P = m ? (T ? C('entries') : E) : void 0;
        ...
        if (
          (O &&
            ...
            b.next &&
            (u(b, _, !0), r || typeof b[l] === 'function' || a(b, l, f)),
          T &&
            k &&
            k.name !== 'values' &&
            ((R = !0),
          ...
          if (((y = { values: T ? E : C('values'), keys: v ? E : C('keys'), entries: P }), g))
            for (S in y) S in w || o(w, S, y[S]);
          else i(i.P + i.F * (p || R), t, y);
        return y;
      };
    },
    ,
    ...
    function(e, t, n) {
      ...
      const o = {
        ...
        detectBrowser(e) {
          ...
          const n = { browser: null, version: null };
    ...
    function(e, t, n) {
      ...
      (a.STATS_FUN = ((r = {}),
      (0, o.default)(r, a.SDK_TYPE.NETCALL, 1),
      (0, o.default)(r, a.SDK_TYPE.WEBRTC, 1),
      (0, o.default)(r, a.SDK_TYPE.NRTC, 1),
      (0, o.default)(r, a.SDK_TYPE.WHITEBOARD, 0),
      r)),
        (a.STATS_RTC = ((i = {}),
    ...
    function(e, t, n) {
      ...
      const M = x && x.stringify;

      const D = f('_hidden');

      const L = f('toPrimitive');
      ...
      let H = !G || !G.prototype || !G.prototype.findChild;
      ...
      const Y = function(e) {
        const t = (V[e] = T(A.prototype));
        return (t._k = e), t;
      };

      const z =
        B && typeof A.iterator === 'symbol'
          ? function(e) {
      ...
      var K = function(e, t, n) {
        return (
          ...
          i(V, t)
            ? (n.enumerable
                ? (i(e, D) && e[D][t] && (e[D][t] = !1), (n = T(n, { enumerable: _(0, !1) })))
                : (i(e, D) || O(e, D, _(1, {})), (e[D][t] = !0)),
              W(e, t, n))
            : O(e, t, n)
        );
      };
      ...
      const J = function(e, t) {
        y(e);
        for (var n, r = v((t = b(t))), i = 0, o = r.length; o > i; ) K(e, (n = r[i++]), t[n]);
        return e;
      };

      const Q = function(e) {
        const t = j.call(this, (e = C(e, !0)));
        return (
          !(this === F && i(V, e) && !i(U, e)) &&
      ...
      const q = function(e, t) {
        if (((e = b(e)), (t = C(t, !0)), e !== F || !i(V, t) || i(U, t))) {
          const n = P(e, t);
          return !n || !i(V, t) || (i(e, D) && e[D][t]) || (n.enumerable = !0), n;
        }
      };

      const $ = function(e) {
        for (var t, n = I(b(e)), r = [], o = 0; n.length > o; )
          i(V, (t = n[o++])) || t == D || t == c || r.push(t);
        return r;
      };

      const X = function(e) {
        for (var t, n = e === F, r = I(n ? U : b(e)), o = [], a = 0; r.length > a; )
          !i(V, (t = r[a++])) || (n && !i(F, t)) || o.push(V[t]);
        return o;
      };
      B ||
        (s(
          (A = function() {
            ...
            return o && H && W(F, e, { configurable: !0, set: t }), Y(e);
          }).prototype,
          'toString',
          function() {
            return this._k;
        ...
        (n(26).f = Q),
        (n(33).f = X),
        o && !n(20) && s(F, 'propertyIsEnumerable', Q, !0),
        (h.f = function(e) {
          return Y(f(e));
        })),
      ...
      for (
        ...
        f(Z[ee++]);
      for (let te = E(f.store), ne = 0; te.length > ne; ) m(te[ne++]);
      a(a.S + a.F * !B, 'Symbol', {
        for(e) {
            ...
            a.S +
              a.F *
                (!B ||
                  u(() => {
                    const e = A();
                    return M([e]) != '[null]' || M({ a: e }) != '{}' || M(Object(e)) != '{}';
                  })),
            'JSON',
            {
              stringify(e) {
                ...
                if (((n = t = r[1]), (S(t) || void 0 !== e) && !z(e)))
                  return (
                    g(t) ||
                      (t = function(e, t) {
                        if ((typeof n === 'function' && (t = n.call(this, e, t)), !z(t))) return t;
                      }),
                    (r[1] = t),
                    M.apply(x, r)
                  );
        ...
        A.prototype[L] || n(10)(A.prototype, L, A.prototype.valueOf),
        l(A, 'Symbol'),
        l(Math, 'Math', !0),
        l(r.JSON, 'JSON', !0);
    },
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = {
          html2node(e) {
            ...
            const i = [];
            if (t.children) for (n = 0, r = t.children.length; n < r; n++) i.push(t.children[n]);
            else
              for (n = 0, r = t.childNodes.length; n < r; n++) {
    ...
    function(e, t, n) {
      ...
      const o = function(e, t) {
        if ((i(e), !r(t) && t !== null)) throw TypeError(`${t}: can't set as prototype!`);
      };
      e.exports = {
        set:
          ...
          ('__proto__' in {}
            ? (function(e, t, r) {
                try {
                  (r = n(44)(Function.call, n(68).f(Object.prototype, '__proto__').set, 2))(e, []),
    ...
    function(e, t, n) {
      ...
      const l = (function(e) {
        function t() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          (0, r.default)(this, t);
          const n = (0, i.default)(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
          return (
      ...
      (p.init = function() {
        ...
        (p.connect = function() {
          ...
          const r = void 0 === n ? this.wssUrl : n;
          ...
          return (
            ...
            r
              ? new Promise((t, n) => {
                  ...
                  let i = void 0;
                  try {
                    i = e.ws = new WebSocket(`wss://${r}`);
                    const o = e;
                    (i.onopen = function(n) {
                      (e.wssUrl = r),
                        o.initSignal(),
                        (o.signalConnected = !0),
                        console.log('signalConnected', r),
                        o.emit('signalConnected'),
                        t(o),
                        e.heartbeat();
                    }),
                      (i.onclose = i.onerror = function(e) {
                        (o.signalConnected = !1), n(e);
                      });
                  } catch (t) {
        ...
        (p.onHeartBeat = function(e) {
          this.heartBeatList.shift(), this.bindHearBeat(5);
        }),
        (p.heartBeatHandler = function() {
          ...
          if (t) {
            ...
            if (o > 3e4)
              ...
              const s = this.getContentData({ type: 'keep_alive', uid: e.uid, cid: e.cid }, r);
              this.send(s), this.bindHearBeat(2);
            }
          }
        }),
        (p.getContentData = function() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ...
    function(e, t, n) {
      ...
      (r.localCName = r.generateIdentifier()),
        ...
        (r.matchPrefix = function(e, t) {
          return r.splitLines(e).filter(e => {
        ...
        (r.parseRtpMap = function(e) {
          ...
          return (
            ...
            (n.channels = t.length === 3 ? parseInt(t[2], 10) : 1),
        ...
        (r.parseSsrcMedia = function(e) {
          ...
          const n = { ssrc: parseInt(e.substr(7, t - 7), 10) };
        ...
        (r.parseRtpParameters = function(e) {
          for (
            ...
            const a = r.matchPrefix(e, `a=rtpmap:${o} `)[0];
            if (a) {
              const s = r.parseRtpMap(a);

              const c = r.matchPrefix(e, `a=fmtp:${o} `);
              switch (
                ((s.parameters = c.length ? r.parseFmtp(c[0]) : {}),
        ...
        (r.parseRtpEncodingParameters = function(e) {
          ...
          const i = r.parseRtpParameters(e);
          ...
          const u = r.matchPrefix(e, 'a=ssrc-group:FID').map(e => {
            return e
              .substr(17)
              .split(' ')
              .map(e => {
          ...
          u.length > 0 && u[0].length > 1 && u[0][0] === c && (t = u[0][1]),
            i.codecs.forEach(e => {
              if (e.name.toUpperCase() === 'RTX' && e.parameters.apt) {
                let r = { ssrc: c, codecPayloadType: parseInt(e.parameters.apt, 10) };
                c && t && (r.rtx = { ssrc: t }),
                  n.push(r),
                  o &&
        ...
        (r.parseMsid = function(e) {
          ...
          if (n.length === 1) return { stream: (t = n[0].substr(7).split(' '))[0], track: t[1] };
          const i = r
            .matchPrefix(e, 'a=ssrc:')
            .map(e => {
              return r.parseSsrcMedia(e);
        ...
        (r.writeSessionBoilerplate = function(e, t) {
          const n = void 0 !== t ? t : 2;
          return `v=0\r\no=thisisadapterortc ${e ||
            r.generateSessionId()} ${n} IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n`;
        }),
        (r.writeMediaSection = function(e, t, n, i) {
          let o = r.writeRtpDescription(e.kind, t);
          if (
          ...
          return (
            ...
            e.rtpSender &&
              e.sendEncodingParameters[0].rtx &&
              (o += `a=ssrc:${e.sendEncodingParameters[0].rtx.ssrc} cname:${r.localCName}\r\n`),
            o
          );
        }),
        (r.getDirection = function(e, t) {
          for (let n = r.splitLines(e), i = 0; i < n.length; i++)
            switch (n[i]) {
              case 'a=sendrecv':
              case 'a=sendonly':
              case 'a=recvonly':
    ...
    function(e, t, n) {
      ...
      const p = ((window.RTCSessionDescription =
    ...
    function(e, t, n) {
      ...
      const r = n(64).RtcSupport.checkWebAudio();
      function i() {
        const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        ...
        const o = e.isRemote;
        (this.support = r.WebAudio && r.MediaStream),
          (this.gain = 1),
          (this.stream = t),
          this.support &&
            ((this.audioIn = {}),
      ...
      (i.ac = r.WebAudio && r.MediaStream ? new window.AudioContext() : {}),
      ...
      (o.context = i.ac),
        ...
        (o.initMonitor = function() {
          ...
          (this.script = this.context.createScriptProcessor(0, 1, 1)).onaudioprocess = function(t) {
            ...
            const r = t.inputBuffer.getChannelData(0);
        ...
        (o.initAudioIn = function() {
          ...
          if (/(MediaStream|LocalMediaStream)/.test(n.constructor))
            return o(n), void (this.outputStream = this.destination.stream);
          function o(e) {
            if (!/(MediaStream|LocalMediaStream)/.test(e.constructor)) return null;
            if (e.getAudioTracks().length === 0) return null;
            const n = r.createMediaStreamSource(e);
            return (
              t.isAnalyze && t.script && (n.connect(t.script), t.script.connect(t.gainFilter)),
    ...
    function(e, t, n) {
      ...
      let p = d.setImmediate;

      let f = d.clearImmediate;
      ...
      (p && f) ||
        ...
        n(32)(l) == 'process'
          ...
          : m && m.now
            ...
            : h
              ? ((o = (i = new h()).port2), (i.port1.onmessage = S), (r = a(o.postMessage, o, 1)))
            ...
            },
            {
              ...
              value() {
                ...
                if (n) {
                  ...
                  return r
                    ? t
                        .connect({ url: r, imInfo: this.imInfo })
                        .then(t => {
                          return (
                            (e.signal = t),
                            e._initSignalEvent(),
    ...
    function(e, t, n) {
      ...
      (l.init = function() {
        ...
        (l.baseHangup = function() {
          ...
          const r = e.recordType;
          if (n) {
            const i = e.fn || 'hangup';
            this.nim[i]({ channelId: n });
          }
          n === this.channelId &&
            (this.isCaller &&
              !this.callAccepted &&
              (this.logger.log(r, { channelId: n }), this.packNetcallRecord({ recordType: r })),
        ...
        (l.packNetcallRecord = function() {
          ...
          const r = e.channelId || this.channelId;
            ...
            content: {
              msg: {
                attach: JSON.stringify({
                  data: { calltype: n, channel: r, duration: i, ids: [c, s], time: l },
                  id: t,
                }),
                from: u,
        ...
        (l.initSession = function() {
          ...
          n.netcallType && (r.netcallType = n.netcallType),
        ...
        (l.onNotifyJoin = function(e) {
          if (this.logger) {
            ...
            for (const r in (this.parseAccountUidMap(t), t)) {
              const i = r;
      ...
      (c.init = function(e) {
        ...
        (c.update = function(e, t) {
          ...
          if (
            ...
            this.paramSecond.packetsLostVideoList.push(parseFloat((r[0] && r[0].packetsLost) || 0)),
            ...
            if (t === 2) {
              ...
              this.paramSecond.googInterframeDelayMaxList[1] > 200 &&
                ...
                (this.paramSecond.vrdolr = l + p),
                (this.paramSecond.vrdohr = f + h);
            }
            t % 2 == 0 &&
        ...
        (c.updateRxMediaInfo = function(e, t) {
          ...
          e.map(e => {
            r.u.push(parseFloat(e.id.split('_')[1])),
              r.g.push(-1),
              r.c.push(-1),
              r.bn.push(parseFloat((e.bitsReceivedPerSecond / 1024).toFixed(1)) || 0),
              r.bc.push(-1);
          }),
            t.map(e => {
              i.u.push(parseFloat(e.id.split('_')[1])),
                ...
                i.vrdolr.push(n.paramSecond.vrdolr || -1),
                i.vrdohr.push(n.paramSecond.vrdohr || -1);
            }),
            this.infos.rx.audio.push(r),
        ...
        (c.updateTxMediaInfo = function(e, t) {
          ...
          for (const r in n) this.infos.tx[r].push(n[r]);
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = {
          ...
          _pipe() {
            ...
            const r = t.shift();
            return (n && n.constructor === Promise ? n : Promise.resolve(n)).then(() => {
              return t.length === 0
                ? e._pipeLast(r, n)
                : e._pipeLast(r, n).then(n => {
                    return e._pipe(t, n);
                  });
            });
          },
          _pipeLast(e, t) {
            ...
            if (e.constructor === Function) {
              const n = e(t);
              return n && n.constructor === Promise ? n : Promise.resolve(n);
            }
            return Promise.resolve(e);
          },
        }),
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        switchVideoToAudio() {
          ...
          return (
            ...
            this.controller
              .switchVideoToAudio()
              .then(() => {
                return (e.type = r.constantRtc.NETCALL_TYPE_AUDIO), Promise.resolve();
              })
              .catch(e => {
                return Promise.resolve(e);
              })
        ...
        switchAudioToVideo() {
          ...
          return (
            ...
            this.controller
              .switchAudioToVideo()
              .then(() => {
                return (e.type = r.constantRtc.NETCALL_TYPE_VIDEO), Promise.resolve();
              })
              .catch(e => {
                return Promise.resolve(e);
              })
        ...
        updateRtmpHostVideo(e) {
          ...
          let n = e.uid;
          return (
            t && (n = this.getUidWithAccount(t)),
            n
              ? this.controller.updateRtmpHostVideo(n)
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        startRemoteStream() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return (
            (e.node = r.element.n2node(e.node)),
      ...
      (t.default = {
        ...
        initStats() {
          ...
          (this.stats = new o.RtcStats({ controller: this, interval: 2e3 })),
            ...
            this.statsNew.on('stats', (t, n) => {
              n % 2 == 0 && e.uploadDataRtcNew(t), e.uploadDataRtc(!1, t, n);
            }),
        ...
        uploadDataRtcStart() {
          this.info.appKey &&
            r.default.STATS_FUN[r.default.CURRENT.SDK_TYPE] &&
            this.dataRtc &&
            this.dataRtc.start({
              info: this.info,
              controller: this,
        ...
        uploadDataRtcStop() {
          r.default.STATS_RTC[r.default.CURRENT.SDK_TYPE] && this.dataRtc && this.dataRtc.stop();
        },
        uploadDataRtcOnce(e) {
          if (r.default.STATS_RTC[r.default.CURRENT.SDK_TYPE] && this.dataRtc) {
        ...
        uploadDataRtc(e, t, n) {
          r.default.STATS_RTC[r.default.CURRENT.SDK_TYPE] &&
            this.info.appKey &&
            this.dataRtc &&
            (e !== 'volume' ? this.dataRtc.update(t, n) : this.dataRtc.updateLocalVolumn(t));
        },
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        startRecordMp4() {
          ...
          let n = e.uid;
          if (t)
            if (t === this.info.client.getAccount()) n = this.imInfo.uid;
            else if (!(n = this.info.client.getUidWithAccount(t)))
              return Promise.reject('账号不在房间中，无法进行录制');
          t = t || this.info.client.getAccount();
          const r = [];
          if (n && n - this.imInfo.uid != 0) {
            const i = this.remoteNode[n];
            if (!i) return Promise.reject('需要录制的账号不正确');
            i.remoteAudioStream && r.push(i.remoteAudioStream.stream),
              i.remoteVideoStream && r.push(i.remoteVideoStream.stream);
          } else
            this.localAudioStream && r.push(this.localAudioStream.stream),
              this.localVideoStream && r.push(this.localVideoStream.stream);
          return r.length === 0
            ? Promise.reject('当前没有音视频数据，无法进行录制')
            : this.rtcRecorder.start(r, { account: t, uid: n });
        },
        stopRecord() {
        ...
        startRecordAac() {
          ...
          for (const i in r)
            r[i].remoteAudioStream &&
              r[i].remoteAudioStream.stream &&
              n.push(r[i].remoteAudioStream.stream);
          return this.rtcRecorder.start(n, { account: e, uid: t, type: 'audio' });
        },
        updateRtmpUrl() {
        ...
        updateRtmpHostVideo(e) {
          ...
          const n = this.imInfo.turnToken || (this.imInfo.serverMap && this.imInfo.serverMap.token);
          return n
            ? (0, r.ajax)({
                type: 'post',
                url: t,
    ...
    function(e, t, n) {
      ...
      const o = n(113);
      const a = n(4).info.nrtcSdkVersion;
      ...
      (t.default = {
        destroyRemoteNode(e) {
          ...
          for (const n in t) this.destroyRemoteRtc(n), this.destroyRemoteMediaStream(n);
        },
        destroyRemoteRtc(e) {
        ...
        createOffer() {
          ...
          return o
            .createOffer()
            .then(e => {
              return o.setLocalDescription(e, r);
            })
            .then(t => {
              return (
                e.sendOffer({ chromeShare: s, offer: t, isUpdate: r, targetUid: o.targetUid }),
                Promise.resolve()
              );
            });
        },
        ...
        sendLocalMessage() {
          ...
          const l = i ? 'client_login' : n ? 'sdp_update' : 'sdp_offer';

          const p = this.mediaDevices.getDeviceStatus();
          ...
          const f = {
            ...
            hasAudio: !i && ((this.deviceAudioStatus && p.hasAudio && !this.imInfo.role) || !1),
            hasVideo:
              !i && ((this.deviceVideoStatus && p.hasVideo && !this.imInfo.role) || s || !1),
          };
          this.sendMsg(l, f),
        ...
        sendRemoteMessage() {
          ...
          const i = {
            session_mode: r.sessionMode || 'p2p',
            params: {
              token: r.token || `${r.cid}`,
              user_type: r.token ? 3 : 2,
              user_token_type: 0,
              content: t,
              version: +a,
              dst_id: n,
        ...
        sendAnswer(e, t) {
          const n = { params: { content: e, streamSetting: { video: this.imInfo.videoConfig } } };
          t && (n.params.dst_id = t), this.sendMsg('sdp_answer', n);
        },
        onsdp_answer(e) {
          this.logger.log('webrtc-controller::onSdp_answer:uid -> ', e);
          const t = e.params.auth_res - 0;

          const n = e.params.dst_id || this.imInfo.uid;
          if (t !== 200)
            return (
          ...
          const r = n - this.imInfo.uid == 0 ? this.rtc : this.remoteNode[n].rtc;
          r && r.setRemoteDescription(e.params.content, 'answer');
        },
        onice_answer(e) {
          let t = e.params.content;

          const n = e.params.dst_id || this.imInfo.uid;
          (void 0 === t ? 'undefined' : (0, r.default)(t)) !== 'object' && (t = { candidate: t });
          const i = n - this.imInfo.uid == 0 ? this.rtc : this.remoteNode[n].rtc;
        ...
        onRemoteStream() {
          ...
          this.doRemoteStream(n, t, r);
        },
        composeTrack(e, t, n, r) {
          if (e !== this.imInfo.uid) {
            const i = this.remoteNode[e];

            const a = new MediaStream();

            const s = n === 'audio' ? 'remoteAudioStream' : 'remoteVideoStream';
            a.addTrack(t),
              i[s]
                ? i[s].updateStream(a)
                : (i[s] = new o.MStream({
              ...
              this.logger.log('webrtc::composeTrack ', e, n, t.id, t.readyState),
              n === 'audio' && i.isAudioEnable && i[s].show(),
              n === 'video' && this.delayVideoShow(e);
          }
        },
        delayVideoShow(e) {
          const t = this;
          ...
          const n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
          setTimeout(() => {
            t._delayVideoShow(e, n);
          }, 100);
        },
        _delayVideoShow(e) {
          let t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
          if (e && e !== this.imInfo.uid) {
            const n = this.remoteNode[e];

            const r = n.remoteVideoStream;
            if (n && r) {
              if (
                ...
                let o = {};
                n.isVideoEnable && t && (o = this.checkRemoteTrack(e, n.rtc.sdpAnswer.sdp)),
                  (t = o.video);
              }
              const a = n.isVideoEnable && t ? 'show' : 'hide';
              r[a] && r[a](),
                a === 'show' && r.resize(n.videoSizeOptions || this.videoViewRemoteSizeOptions),
        ...
        switchTrackEvent() {
          ...
          if (n && r) {
            if (!(void 0 === i || i))
              return (
                (n.onaddtrack = null),
                (n.onremovetrack = null),
                this.logger.log('webrtc-controller::remove trackevent: onaddtrack', n.id),
                void this.logger.log('webrtc-controller::remove trackevent: onremovetrack', n.id)
              );
            n.onaddtrack ||
              (this.logger.log('webrtc-controller::add trackevent onaddtrack', n.id),
              (n.onaddtrack = function(t) {
                e.emit('addtrack', t);
                const i = t.track;

                const o = i.kind;
                if (
                  (e.logger.log('webrtc-controller::on add track:', n.id, o, i.id, i.readyState),
                  e.composeTrack(r, i, o),
                  e.emit('remoteTrack', { uid: r, track: i }),
                  o === 'video')
                ) {
                  const a = e.remoteNode[r].rtc;

                  const s = a.rtcConnection && a.rtcConnection.remoteDescription.sdp;
                  e.checkRemoteTrack(r, s), e.delayVideoShow(r);
                }
              })),
              n.onremovetrack ||
                (this.logger.log('webrtc-controller::add trackevent onremovetrack', n.id),
                (n.onremovetrack = function(t) {
                  const i = t.track;

                  const o = i.kind;

                  const a = e.remoteNode[r];
                  a &&
                    (e.logger.warn(
        ...
        doRemoteStream(e, t, n) {
          /Firefox/gi.test(navigator.userAgent)
            ? this.doRemoteStreamFirefox(e, t, n)
            : this.doRemoteStreamChrome(e, t, n);
        },
          ...
          this.logger.log(
            ...
            e &&
              e.getTracks().forEach(e => {
                n.logger.log('   > track id:', `${e.kind}:${e.id}`, e);
              });
          const r = e.getAudioTracks()[0];

          const i = e.getVideoTracks()[0];
          r && this.composeTrack(t, r, 'audio', e),
            i && this.composeTrack(t, i, 'video', e),
            this.switchTrackEvent({ stream: e, uid: t }),
            r && this.emit('remoteTrack', { uid: t, track: r }),
            i && this.emit('remoteTrack', { uid: t, track: i });
        },
        doRemoteStreamFirefox(e, t, n) {
          const r = this.remoteNode[t];
          r &&
            r.rtc &&
            (this.logger.log(`webrtc-controller::get ${t} track: `, n && n.id, n),
            s || (s = i.RtcSupport.checkVersion()),
            n &&
              (this.composeTrack(t, n, n.kind, e), this.emit('remoteTrack', { uid: t, track: n })));
        },
        onLocalIceCandidate() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          ...
          const n = e.ice;
          if (!/\d tcp \d/gi.test(n.candidate)) {
            const r = { params: { content: n, dst_id: t } };
            this.sendMsg('ice_offer', r);
          }
        },
        ...
        onIceStateChange(e) {
          ...
          const r = t.targetUid;
          if (
            (this.logger.log(`webrtc-controller::${r} ice connection state change to: ${n}`),
            n === 'connected' && r === this.imInfo.uid && this.emit('sessionConnected'),
            n === 'failed')
          ) {
            if ((this.logger.error(`webrtc-controller::${r} ice failed`), r - this.imInfo.uid == 0))
        ...
        updateRtcStream() {
          ...
          const t = [];
          if (e) {
            const n = this.localAudioStream;

            const r = this.localVideoStream;
            n && n.stream && t.push(n.stream), r && r.stream && t.push(r.stream);
          }
        ...
        checkRemoteTrack(e, t) {
          const n = this.remoteNode[e];
          if (!n) return {};
          const r = n.remoteAudioStream && n.remoteAudioStream.audioStream;

          const i = n.remoteVideoStream && n.remoteVideoStream.stream;
          if ((!r && !i) || !n.rtc) return {};
          const o = n.rtc.checkMediaStatus({ audio: r, video: i, sdp: t, uid: e });
          return (
            this.logger.log('webrtc-controller::checkRemoteTrack:uid -> ', e, o),
            o.video || (n.remoteVideoStream && n.remoteVideoStream.hide()),
            o
          );
        },
      }),
      ...
      (t.default = {
          ...
          return new Promise((n, r) => {
            if (e === i.constantRtc.DEVICE_TYPE_VIDEO) {
              if (
                ...
                return t.disableDevice(e).then(n, r);
              ...
              if (
                ...
                return t.disableDevice(e).then(n, r);
              if (t.localAudioStream) return t.localAudioStream.stopDevice(), n();
            } else
        ...
        startDevice(e) {
          ...
          return new Promise((n, r) => {
            ...
            if (
              ...
              return t.setAudioStart({ uid: -1 }), n();
            if (o === i.constantRtc.DEVICE_TYPE_AUDIO_OUT_CHAT)
              return t.setAudioStart({ account: s, uid: c }), n();
                    ...
                    t
                      ...
                      .then(() => {
                        return o === i.constantRtc.DEVICE_TYPE_VIDEO
                          ? t.getStream('Video', a, n, r)
                          : o === i.constantRtc.DEVICE_TYPE_AUDIO_IN
                            ? t.getStream('Audio', a, n, r)
                            : o === i.constantRtc.DEVICE_TYPE_DESKTOP_CHROME_SCREEN
                              ? ((t.deviceAudioStatus = !0),
                                (t.deviceVideoStatus = !0),
                                t.getStream('ChromeScreen', o, n, r))
                              : o === i.constantRtc.DEVICE_TYPE_DESKTOP_SCREEN ||
                                o === i.constantRtc.DEVICE_TYPE_DESKTOP_WINDOW
                                ? ((t.deviceAudioStatus = !0),
                                  (t.deviceVideoStatus = !0),
                                  t.getStream('Screen', o, n, r))
                                : void 0;
                      })
                      .catch(e => {
                        /重复操作/.test(e) ? n() : r(e);
        ...
        _getVideoStream(e, t, n) {
          ...
          if (
            ...
            return this.enableDevice(i.constantRtc.DEVICE_TYPE_VIDEO).then(t, n);
          let u = { deviceId: {} };
        ...
        _getAudioStream(e, t, n) {
          ...
          return (
            ...
            r.MStream.getLocalStream(s)
              .then(n => {
                i._initAudioStream(s, n), t({ device: e, stream: n });
              })
              .catch(e => {
                n(e);
              })
        ...
        _initAudioStream(e) {
          ...
          this.localAudioStream
            ...
            : ((this.localAudioStream = new r.MStream({
                stream: t,
                type: 'audio',
                isRemote: !1,
                constraint: e,
        ...
        _getChromeScreenStream(e, t, n) {
          ...
          if (o) {
            ...
            return new Promise((e, t) => {
              chrome.runtime.sendMessage(o, a, {}, n => {
                if (
                  (i.localVideoStream &&
                    (i.localVideoStream.destroy(), (i.localVideoStream = null)),
                  console.log('chrome 屏幕共享', n),
                  n && n.type === 'success')
                ) {
                  const o = {
                    video: {
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        destroyRemoteMediaStream(e) {
          if (e && this.remoteNode && this.remoteNode[e]) {
            ...
            t.remoteVideoStream && t.remoteVideoStream.destroy(),
              ...
              (this.remoteNode[e] = null);
            const n = this.remoteStreams[e];
            this.switchTrackEvent({ stream: n, uid: e, isOn: !1 }), r.MStream.destroyMedia(n);
          }
        },
        setCaptureVolume(e) {
          (void 0 === e || e > 1) && (e = 1),
        ...
        setAudioStart(e) {
          ...
          const n = e.uid;
          if ((console.log('setAudioStart', n), n !== -1))
        ...
        startRemoteStream() {
          ...
          if (
            this.imInfo.sessionMode === 'p2p' &&
            !t &&
            ((t = this.info.client.target.uid), !this.info.remoteContainer && !n)
          )
          ...
          if (((n = n || this.info.remoteContainer), i))
            return (
              (i.container = (e && n) || i.container),
              i.container
          ...
          for (const a in o) {
            if (((o[a].container = (e && n) || o[a].container), !o[a].container))
              return Promise.reject(`${t} 开启显示远端视频画面失败: 请传递video容器`);
            s(o[a]);
          }
          return Promise.resolve();
          function s(t) {
            (t.container = (e && n) || t.container),
              (t.isVideoEnable = !0),
              t.remoteVideoStream &&
                (t.remoteVideoStream.resize(t.videoSizeOptions),
                t.remoteVideoStream.show(t.container, r));
          }
        },
        stopRemoteStream() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        ...
        optionRemoteStream(e) {
          ...
          return (
            n &&
              ...
              (t = Object.assign(t, n)).account.constructor === Object &&
              delete t.account,
            t.uid ||
        ...
        doOptionRemoteStream() {
          ...
          if (
            ...
            this.imInfo.sessionMode !== 'p2p' || n || (n = this.info.client.target.uid),
            !n && r && !(n = this.info.client.getUidWithAccount(r)))
          )
            return Promise.reject('目标账号不正确或者未在当前会话中');
          if (n) return (a = this.remoteNode[n]) && c(a), Promise.resolve();
      ...
      e.exports = {
        shimRTCIceCandidate(e) {
          if (!(e.RTCIceCandidate && 'foundation' in e.RTCIceCandidate.prototype)) {
            ...
            (e.RTCIceCandidate = function(e) {
              ...
              const i = r.parseCandidate(e.candidate);
        ...
        shimCreateObjectURL(e) {
          ...
          if (
            ...
            const n = t.createObjectURL.bind(t);

            const r = t.revokeObjectURL.bind(t);
      ...
      const i = {
            ...
            if (
              ...
              'getStreamById' in e.RTCPeerConnection.prototype ||
                (e.RTCPeerConnection.prototype.getStreamById = function(e) {
                  ...
                  return (
                    this._localStreams &&
                      this._localStreams.forEach(n => {
                        n.id === e && (t = n);
                      }),
                    this._remoteStreams &&
                      this._remoteStreams.forEach(n => {
                        n.id === e && (t = n);
                      }),
                    t
                  );
              ...
              (e.RTCPeerConnection.prototype.addStream = function(e) {
                ...
                (e.RTCPeerConnection.prototype.addTrack = function(e, n) {
                  return (
                    n &&
                      (this._localStreams
                        ? this._localStreams.indexOf(n) === -1 && this._localStreams.push(n)
        ...
        shimCallbacksAPI(e) {
          if (typeof e === 'object' && e.RTCPeerConnection) {
            ...
            const n = t.createOffer;

            const r = t.createAnswer;
        ...
        shimCreateOfferLegacy(e) {
          ...
          e.RTCPeerConnection.prototype.createOffer = function(e) {
            const n = this;
            if (e) {
              const r = n.getTransceivers().find(e => {
                return e.sender.track && e.sender.track.kind === 'audio';
              });
              !1 === e.offerToReceiveAudio && r
                ? r.direction === 'sendrecv'
                  ? r.setDirection('sendonly')
                  : r.direction === 'recvonly' && r.setDirection('inactive')
                : !0 !== e.offerToReceiveAudio || r || n.addTransceiver('audio');
              const i = n.getTransceivers().find(e => {
              ...
              !1 === e.offerToReceiveVideo && i
                ...
                : !0 !== e.offerToReceiveVideo || i || n.addTransceiver('video');
            }
    ...
    function(e, t, n) {
      ...
      e.exports = function(e) {
            ...
            return (
              Object.keys(e).forEach(n => {
                if (n !== 'require' && n !== 'advanced' && n !== 'mediaSource') {
                  const r = (e[n] = typeof e[n] === 'object' ? e[n] : { ideal: e[n] });
                  if (
                    ((void 0 === r.min && void 0 === r.max && void 0 === r.exact) || t.push(n),
                    void 0 !== r.exact &&
                      (typeof r.exact === 'number' ? (r.min = r.max = r.exact) : (e[n] = r.exact),
                      delete r.exact),
                    void 0 !== r.ideal)
                  ) {
                    e.advanced = e.advanced || [];
                    const i = {};
                    typeof r.ideal === 'number'
        ...
        if (
          ...
          const c = n.mediaDevices.enumerateDevices.bind(n.mediaDevices);
        ...
        if (t.version < 49) {
          const u = n.mediaDevices.getUserMedia.bind(n.mediaDevices);
        ...
        if (!(t.version > 55 && 'autoGainControl' in n.mediaDevices.getSupportedConstraints())) {
          ...
          if (
            ...
            const p = o.prototype.getSettings;
          ...
          if (o && o.prototype.applyConstraints) {
            const f = o.prototype.applyConstraints;
                  ...
                  this.addEventListener(
                    ...
                    (this._ontrackpoly = function(e) {
                      e.stream.getTracks().forEach(t => {
                        ...
                        (n.track = t),
                          (n.receiver = { track: t }),
                          (n.transceiver = { receiver: n.receiver }),
                          (n.streams = [e.stream]),
    ...
    function(e, t, n) {
      e.exports = function(e) {
        ...
        const n = t.mediaDevices.getUserMedia.bind(t.mediaDevices);
    ...
    function(e, t, n) {
      ...
      function o(e, t) {
        const n = { codecs: [], headerExtensions: [], fecMechanisms: [] };
        ...
        const i = function(e, t, n, i) {
          const o = r(e.parameters.apt, n);

          const a = r(t.parameters.apt, i);
        ...
        return (
              ...
              if (r.name.toLowerCase() === a.name.toLowerCase() && r.clockRate === a.clockRate) {
                ...
                ((a = JSON.parse(JSON.stringify(a))).numChannels = Math.min(
                  ...
                  (a.rtcpFeedback = a.rtcpFeedback.filter(e => {
                    for (let t = 0; t < r.rtcpFeedback.length; t++)
                      if (
          ...
          e.headerExtensions.forEach(e => {
            for (let r = 0; r < t.headerExtensions.length; r++) {
              const i = t.headerExtensions[r];
              if (e.uri === i.uri) {
      ...
      function s(e, t) {
        const n = e.getRemoteCandidates().find(e => {
          return (
      ...
      e.exports = function(e, t) {
        ...
        const d = function(n) {
          ...
          if (
            ...
            (this.usingBundle = n.bundlePolicy === 'max-bundle'),
            n.rtcpMuxPolicy === 'negotiate')
          )
          ...
          if (
            ...
            for (let a = n.iceCandidatePoolSize; a > 0; a--)
        ...
        Object.defineProperty(d.prototype, 'localDescription', {
          ...
          (d.prototype._createTransceiver = function(e, t) {
            const n = this.transceivers.length > 0;
          ...
          (d.prototype.removeTrack = function(t) {
            ...
            const n = this.transceivers.find(e => {
          ...
          (d.prototype._createIceGatherer = function(t, n) {
            ...
            return (
              ...
              (this.transceivers[t].bufferCandidates = function(e) {
                const n = !e.candidate || Object.keys(e.candidate).length === 0;
                (i.state = n ? 'completed' : 'gathering'),
                  r.transceivers[t].bufferedCandidateEvents !== null &&
          ...
          (d.prototype._gather = function(t, n) {
            ...
            const o = this.transceivers[n].iceGatherer;
            if (!o.onlocalcandidate) {
              const a = this.transceivers[n].bufferedCandidateEvents;
              (this.transceivers[n].bufferedCandidateEvents = null),
                ...
                (o.onlocalcandidate = function(e) {
                  if (!(i.usingBundle && n > 0)) {
                    ...
                    const d = r.getMediaSections(i._localDescription.sdp);
                    (d[a.candidate.sdpMLineIndex] += c
                      ? 'a=end-of-candidates\r\n'
                      : `a=${a.candidate.candidate}\r\n`),
                      (i._localDescription.sdp =
                        r.getDescription(i._localDescription.sdp) + d.join(''));
          ...
          (d.prototype._disposeIceAndDtlsTransports = function(e) {
            ...
            const n = this.transceivers[e].iceTransport;
            n && (delete n.onicestatechange, delete this.transceivers[e].iceTransport);
            const r = this.transceivers[e].dtlsTransport;
            r &&
          ...
          (d.prototype.setLocalDescription = function(e) {
            ...
            if (e.type === 'offer')
              (t = r.splitSections(e.sdp)),
                (n = t.shift()),
                t.forEach((e, t) => {
                  const n = r.parseRtpParameters(e);
              ...
              const s = r.matchPrefix(n, 'a=ice-lite').length > 0;
              t.forEach((e, t) => {
                ...
                const p = a.remoteCapabilities;
                if (
                  !(r.isRejected(e) && r.matchPrefix(e, 'a=bundle-only').length === 0) &&
                  !a.rejected
                ) {
                  const f = r.getIceParameters(e, n);

                  const h = r.getDtlsParameters(e, n);
                  s && (h.role = 'server'),
                    (i.usingBundle && t !== 0) ||
                      (i._gather(a.mid, t),
                      u.state === 'new' && u.start(c, f, s ? 'controlling' : 'controlled'),
          ...
          (d.prototype.setRemoteDescription = function(i) {
            ...
            const p = r.splitSections(i.sdp);

            const f = p.shift();

            const h = r.matchPrefix(f, 'a=ice-lite').length > 0;

            const m = r.matchPrefix(f, 'a=group:BUNDLE ').length > 0;
            o.usingBundle = m;
            const v = r.matchPrefix(f, 'a=ice-options:')[0];
            return (
              (o.canTrickleIceCandidates =
                ...
                v
                  ...
                  .indexOf('trickle') >= 0),
              p.forEach((a, c) => {
                const u = r.splitLines(a);

                const p = r.getKind(a);

                const v = r.isRejected(a) && r.matchPrefix(a, 'a=bundle-only').length === 0;

                const g = u[0].substr(2).split(' ')[2];

                const y = r.getDirection(a, f);

                const S = r.parseMsid(a);

                const b = r.getMid(a) || r.generateIdentifier();
                if (v || (p === 'application' && (g === 'DTLS/SCTP' || g === 'UDP/DTLS/SCTP')))
                  o.transceivers[c] = { mid: b, kind: p, protocol: g, rejected: !0 };
                else {
                  let C;
                  let _;
                  let T;
                  ...
                  !v &&
                    ...
                    (o.transceivers[c] = o._createTransceiver(p, !0));
                  let I;

                  let A;

                  const x = r.parseRtpParameters(a);
                  v ||
                    ((I = r.getIceParameters(a, f)),
                    ((A = r.getDtlsParameters(a, f)).role = 'client')),
                    (E = r.parseRtpEncodingParameters(a));
                  const M = r.parseRtcpParameters(a);

                  const D = r.matchPrefix(a, 'a=end-of-candidates', f).length > 0;
                  ...
                  if (
                    ...
                    i.type !== 'answer' ||
                      ...
                      (m && c !== 0) ||
                        (T.state === 'new' && T.start(_, I, 'controlling'),
                        R.state === 'new' && R.start(A)),
                      o._transceive(
                        C,
                    ...
                    ((C = o.transceivers[c] || o._createTransceiver(p)).mid = b),
                      C.iceGatherer || (C.iceGatherer = o._createIceGatherer(c, m)),
                      L.length &&
                        C.iceTransport.state === 'new' &&
                        (!D || (m && c !== 0)
                          ? L.forEach(e => {
                              s(C.iceTransport, e);
                            })
                          : C.iceTransport.setRemoteCandidates(L)),
                      (P = e.RTCRtpReceiver.getCapabilities(p)),
                      t < 15019 &&
                        (P.codecs = P.codecs.filter(e => {
                          return e.name !== 'rtx';
                        })),
                      (k = C.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]);
                    let j;
                    ...
                    if (y === 'sendrecv' || y === 'sendonly') {
                      if (
                        ((N = !C.rtpReceiver),
                        (w = C.rtpReceiver || new e.RTCRtpReceiver(C.dtlsTransport, p)),
                        N)
                      )
                        (O = w.track),
                          (S && S.stream === '-') ||
                          ...
                          j && (n(O, j), C.associatedRemoteMediaStreams.push(j)),
                          l.push([O, w, j]);
                    } else
                      C.rtpReceiver &&
                        C.rtpReceiver.track &&
                        (C.associatedRemoteMediaStreams.forEach(t => {
                          const n = t.getTracks().find(e => {
              ...
              Object.keys(d).forEach(t => {
                ...
                if (n.getTracks().length) {
                  if (o.remoteStreams.indexOf(n) === -1) {
          ...
          (d.prototype._updateIceConnectionState = function() {
            ...
            if (
              ...
              const n = new Event('iceconnectionstatechange');
          ...
          (d.prototype._updateConnectionState = function() {
            ...
            if (
              ...
              const n = new Event('connectionstatechange');
          ...
          (d.prototype.createOffer = function() {
            ...
            let o = n.transceivers.filter(e => {
              return e.kind === 'audio';
            }).length;

            let a = n.transceivers.filter(e => {
              return e.kind === 'video';
            }).length;
            ...
            let u = r.writeSessionBoilerplate(n._sdpSessionId, n._sdpSessionVersion++);
            n.transceivers.forEach((i, o) => {
              const a = i.track;

              const s = i.kind;

              const c = i.mid || r.generateIdentifier();
              (i.mid = c),
              ...
              n._config.bundlePolicy !== 'max-compat' &&
                (u += `a=group:BUNDLE ${n.transceivers
                  .map(e => {
                    return e.mid;
                  })
                  .join(' ')}\r\n`),
              (u += 'a=ice-options:trickle\r\n'),
              n.transceivers.forEach((e, t) => {
                (u += i(e, e.localCapabilities, 'offer', e.stream, n._dtlsRole)),
                  (u += 'a=rtcp-rsize\r\n'),
                  !e.iceGatherer ||
                    n.iceGatheringState === 'new' ||
                    (t !== 0 && n.usingBundle) ||
          ...
          (d.prototype.createAnswer = function() {
            ...
            if (
              n.signalingState !== 'have-remote-offer' &&
              n.signalingState !== 'have-local-pranswer'
            )
              return Promise.reject(
                c(
                  'InvalidStateError',
            ...
            let a = r.writeSessionBoilerplate(n._sdpSessionId, n._sdpSessionVersion++);
            n.usingBundle &&
              (a += `a=group:BUNDLE ${n.transceivers
                .map(e => {
                  return e.mid;
                })
                .join(' ')}\r\n`);
            const s = r.getMediaSections(n._remoteDescription.sdp).length;
            n.transceivers.forEach((e, r) => {
              if (!(r + 1 > s)) {
                if (e.rejected)
                  return (
                    e.kind === 'application'
            ...
            return e && void 0 === e.sdpMLineIndex && !e.sdpMid
              ...
              : new Promise((i, o) => {
                  ...
                  if (e && e.candidate !== '') {
                    ...
                    if (e.sdpMid)
                      for (let u = 0; u < n.transceivers.length; u++)
                        if (n.transceivers[u].mid === e.sdpMid) {
                          a = u;
                          break;
                        }
                    const d = n.transceivers[a];
                    if (!d) return o(c('OperationError', 'Can not add ICE candidate'));
                    if (d.rejected) return i();
                    const l =
                      Object.keys(e.candidate).length > 0 ? r.parseCandidate(e.candidate) : {};
                    if (l.protocol === 'tcp' && (l.port === 0 || l.port === 9)) return i();
                    if (l.component && l.component !== 1) return i();
                    if (
                      (a === 0 || (a > 0 && d.iceTransport !== n.transceivers[0].iceTransport)) &&
                      !s(d.iceTransport, l)
                    )
                      return o(c('OperationError', 'Can not add ICE candidate'));
                    let p = e.candidate.trim();
                    p.indexOf('a=') === 0 && (p = p.substr(2)),
                      ((t = r.getMediaSections(n._remoteDescription.sdp))[a] += `a=${
                        l.type ? p : 'end-of-candidates'
                      }\r\n`),
                    ...
                    for (
                      let f = 0;
                      f < n.transceivers.length &&
                      (n.transceivers[f].rejected ||
                        (n.transceivers[f].iceTransport.addRemoteCandidate({}),
                        ((t = r.getMediaSections(n._remoteDescription.sdp))[f] +=
                          'a=end-of-candidates\r\n'),
                        (n._remoteDescription.sdp =
                          r.getDescription(n._remoteDescription.sdp) + t.join('')),
                        !n.usingBundle));
        ...
        [
          ...
          if (n && n.prototype && n.prototype.getStats) {
            const r = n.prototype.getStats;
            n.prototype.getStats = function() {
              return r.apply(this).then(e => {
                const t = new Map();
                return (
                  Object.keys(e).forEach(n => {
                    (e[n].type = (function(e) {
      ...
      e.exports = function(e) {
        ...
        const o = function(e) {
          ...
          return (
            Object.keys(e).forEach(n => {
              if (n !== 'require' && n !== 'advanced' && n !== 'mediaSource') {
                const r = typeof e[n] === 'object' ? e[n] : { ideal: e[n] };
                void 0 !== r.exact && typeof r.exact === 'number' && (r.min = r.max = r.exact);
                ...
                void 0 !== r.exact && typeof r.exact !== 'number'
          ...
          if (e && typeof e.video === 'object') {
            ...
            if (
              ...
              if (
                ...
                return n.mediaDevices.enumerateDevices().then(t => {
                  let n = (t = t.filter(e => {
                  ...
                  return (
                    !n && t.length && c.indexOf('back') !== -1 && (n = t[t.length - 1]),
                    n &&
                      (e.video.deviceId = s.exact ? { exact: n.deviceId } : { ideal: n.deviceId }),
                    (e.video = o(e.video)),
            ...
            (n.mediaDevices = {
              ...
              enumerateDevices() {
                return new Promise(t => {
                  const n = { audio: 'audioinput', video: 'videoinput' };
          ...
          if (!(e.RTCPeerConnection.prototype.addTrack && t.version >= 64)) {
            ...
            Object.defineProperty(e.RTCPeerConnection.prototype, 'localDescription', {
              ...
              (e.RTCPeerConnection.prototype.removeTrack = function(e) {
                ...
                (n._streams = n._streams || {}),
                  Object.keys(n._streams).forEach(r => {
                    n._streams[r].getTracks().find(t => {
                      return e.track === t;
                    }) && (t = n._streams[r]);
                  }),
                  t &&
      ...
      e.exports = function(e, t) {
        ...
        switch (c.browser) {
          case 'chrome':
            ...
            break;
          case 'firefox':
            if (!p || !p.shimPeerConnection || !o.shimFirefox)
      ...
      const c = (function(e) {
        function t(e) {
          ...
          return (
            (n.logger = e.logger),
            (n.imInfo = e.imInfo),
            (n.sessionConfig = e.sessionConfig),
            (n.controller = e.controller),
            (n.targetUid = e.targetUid || n.imInfo.uid),
            n.init(),
            (n.isProgress = !1),
            n
          );
      ...
      (u.resetStatus = function() {
        ...
        (u.init = function() {
          ...
          if ((this.resetStatus(), !this.rtcConnection)) {
            ...
            const n = (this.rtcConnection = new RTCPeerConnection({
              iceServers: [{ url: 'stun:turn.ideasip.com' }],
            }));
            (n.uid = this.imInfo.uid),
              (n.targetUid = this.targetUid),
              (n.onicecandidate = this.onIceCandidate.bind(this)),
              (n.onnegotiationneeded = this.onNegotiationneeded.bind(this)),
              (n.oniceconnectionstatechange = this.onIceStateChange.bind(this)),
              t
                ? (n.ontrack = this.onRemoteTrack.bind(this))
                : ((n.onaddstream = this.onRemoteStream.bind(this)),
                  (n.onremovestream = function(t) {
        ...
        (u.checkMediaStatus = function(e, t, n) {
          return a.RtcUtil.checkMediaStatus(e, t, n);
        }),
        (u.logSdp = function() {
        ...
        (u.setRemoteDescription = function(e, t) {
          ...
          const r = { sdp: e.sdp, type: e.type };
          if (e.type === 'offer' && !this.sdpAnswer) return Promise.reject();
          (r.sdp = a.SdpUtil.maybePreferVideoSendCodec(r.sdp, { videoRecvCodec: 'H264' })),
            (r.sdp = a.RtcUtil.formatSdpRemote(r.sdp, this.sdpOffer)),
            a.RtcUtil.parse(r.sdp),
            (this.sdpAnswer = e.type === 'answer' ? r : null);
          const i = this.rtcConnection;
          return i
            .setRemoteDescription(r)
            .then(() => {
              if (e.type === 'answer') {
                if (n.iceCompleted) return void n.emit('iceCompleted');
                n.doSendIce();
              }
              return Promise.resolve();
            })
            ...
            this.rtcConnection
              ...
              .then(() => {
                return (
                  ...
                  e.type === 'answer'
                    ? ((n.sdpAnswer = e),
                      n.iceCompleted && n.emit('iceCompleted'),
                      n.setProgress(!1))
                    : (n.sdpAnswer = null),
                  Promise.resolve(e)
                );
              ...
              .catch(t => {
                return n.logger.warn(t), Promise.resolve(e);
              })
          );
        }),
    ...
    function(e, t, n) {
      ...
      const l = (function(e) {
        function t(e) {
          ...
          return (
            (n.isRemote = !!e.isRemote),
            (n.constraint = e.constraint || {}),
            (n.stream = e.stream),
            (n.audioStream = e.stream),
            (n.container = e.container),
            (n.uid = e.uid || ''),
            (n.poster = e.poster || ''),
            (n.isAudio = e.type === 'audio'),
            n.initNode(),
            (n.videoRatioIntervalId = null),
            n.startVideoRatioMonitor(),
            n
          );
        }
        return (
              ...
              },
              {
                ...
                value() {
                  ...
                  n.setAttribute('x-webkit-airplay', 'x-webkit-airplay'),
                    ...
                    this.poster && (n.poster = this.poster),
                    (n.preload = 'auto'),
                    (n.dataset.uid = this.uid),
                    (n.autoplay = 'autoplay'),
                  ...
                  (r.textContent = this.uid), (r.zIndex = 1), t.appendChild(r);
                },
              },
              ...
              },
              {
                ...
                value(e, t) {
                  if (this.node) {
                    ...
                    const n = this.videoContainer;
                    (e = this.container = e || this.container),
                      console.log('node container', n, e),
                      n &&
                        e &&
                        ((n.parentNode && n.parentNode === n) ||
                          (n.parentNode && n.parentNode.removeChild(n), e.appendChild(n)),
                ...
                value(e) {
                  ...
                  if (e) {
                    ...
                    n &&
                      n.length !== 0 &&
                      n.forEach(n => {
                        d.log('destroy track', t.uid || e.id, n), n.stop(), e.removeTrack(n);
                      });
                  }
                },
              },
                  ...
                  return (
                    ...
                    navigator.mediaDevices
                      ...
                      .then(r => {
                        return n === 'audio'
                          ? r
                          : new t({ stream: r, type: n, isRemote: !1, constraint: e });
                      })
                      .catch(t => {
                        const n = t.constructor === Object ? t.name : JSON.stringify(t);
                        return console.error(e, t), Promise.reject(n);
                      })
                  );
                },
              },
      ...
      (t.default = {
            ...
            return navigator.mozGetUserMedia
              ...
              : new Promise((n, r) => {
                  e.getStats(r => {
                    ...
                    (e.lastStats = e.lastStats || {}), (i = t.format(e, i, o)), n(i);
                  });
                });
        },
        getStatsFirefox(e) {
          const t = this;
          return e.getStats(null).then(n => {
        ...
        format(e, t, n) {
          return !e || /(failed|closed)/gi.test(e.iceConnectionState)
            ? {}
            : (t = e.uid - e.targetUid == 0 ? this.ssrcLocal(e, t, n) : this.ssrcRemote(e, t, n));
        },
        formatSSRC(e, t, n, r, i) {
          return this[navigator.mozGetUserMedia ? '_formatSSRC_F' : '_formatSSRC_G'](e, t, n, r, i);
        },
        _formatSSRC_G(e, t, n, r, i) {
          const o = this;
          ...
          return (
            Object.values(t).map(t => {
              if (
                (r !== 'recv' || /^ssrc_/gi.test(t.id)) &&
                (r !== 'send' || /^(bweforvideo|ssrc_)/gi.test(t.id))
              ) {
                t = o.formatData(t);
                const n = new RegExp(`ssrc_(\\d+)_${r}`);

                const s = t.id.match(n);
                ...
                (a[c] = t),
                  ...
                  s &&
                    s[1] &&
                    (r !== 'recv' || e.uid !== 0
                      ? ((t.id = `ssrc_${e.uid}_${r}_${r === 'recv' ? e.targetUid : 0}_${
                          t.mediaType
                        }`),
                        (t = o.computeData(e, t)),
                        (a[t.id] = t),
        ...
        _formatSSRC_F(e, t, n, r) {
          const i = this;

          const o = {};

          const a = new RegExp(`^${r === 'send' ? 'outbound' : 'inbound'}_`, 'i');
          return (
            Object.values(t).map(t => {
              if (a.test(t.id)) {
                const n = t.id;
                (t.id = t.id.replace(/\d+/, `${e.uid}_${r}_${r === 'recv' ? e.targetUid : 0}`)),
                  (t = i.computeData(e, t)),
                  (o[t.id] = t),
                  delete o[n];
              }
        ...
        computeData(e, t) {
          const n = { peer: e, ssrcKey: t.id, currentItem: t };
          return (
            t.bytesSent &&
        ...
        ssrcLocal(e, t, n) {
          const r = e.localDescription;
          return this.formatSSRC(e, t, r.sdp, 'send', n);
        },
        ssrcRemote(e, t, n) {
          const r = e.remoteDescription;
          return this.formatSSRC(e, t, r.sdp, 'recv', n);
        },
        getLastStats() {
          const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          ...
          let o = null;
          return (
            (o = t.lastStats[n] && t.lastStats[n][r] ? i[r] - t.lastStats[n][r] : i[r]),
            (o = /bytes/gi.test(r)
          ...
          (0, a.default)(t, [
            ...
            },
            {
              ...
              value() {
                ...
                (this.controller = t),
                  (this.interval = r),
                  (this.timer = setInterval(this.getStats.bind(this), 1e3 * r));
              },
            },
            {
              key: 'stop',
                      ...
                      function(e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 2:
                              (t = {}),
                                (n = this.controller.remoteNode),
                                (o = Object.keys(n).map(
                                  (function() {
                                    const e = (0, i.default)(
                                      r.default.mark(function e(i) {
                                        return r.default.wrap(
                                          e => {
                                            for (;;)
                                              switch ((e.prev = e.next)) {
                                                case 0:
                                                  ...
                                                  return (
                                                    (n[i].rtc.rtcConnection.interval = f.interval),
                                                    (e.next = 4),
                                                    d.default.getStats(n[i].rtc.rtcConnection)
                                                  );
                                                case 4:
    ...
    function(e, t, n) {
      ...
      const c = (function(e) {
        function t(e) {
          ...
          return (
            (n.peer = e.peer),
            (n.mediaStreamTrack = e.mediaStreamTrack),
            (n.interval = 5e3),
            n.init(),
            n
          );
          ...
          (0, i.default)(t, [
            ...
            },
            {
              ...
              value() {
                ...
                const p = this.REMOTE_networkType;
                (r.datachannel = function(e) {
                  e.type === 'datachannel' && (i.datachannel = { state: e.state });
                }),
                  (r.googCertificate = function(e) {
                    e.type === 'googCertificate' && (i.encryption = e.googFingerprintAlgorithm);
                  }),
                  (r.checkAudioTracks = function(t) {
                    if (
                      t.googCodecName &&
                      t.mediaType === 'audio' &&
                      e.indexOf(t.googCodecName.toLowerCase()) !== -1
                    ) {
                      const n = t.id.split('_').pop();
                      if (
                        (i.audio[n].codecs.indexOf(t.googCodecName) === -1 &&
                          i.audio[n].codecs.push(t.googCodecName),
                        t.bytesSent)
                      ) {
                        var r = 0;
                        if (t.bytesSent) {
                          i.internal.audio[n].prevBytesSent ||
                            (i.internal.audio[n].prevBytesSent = t.bytesSent);
                          var o = t.bytesSent - i.internal.audio[n].prevBytesSent;
                          (i.internal.audio[n].prevBytesSent = t.bytesSent), (r = o / 1024);
                        }
                        i.audio[n].availableBandwidth = r.toFixed(1);
                      }
                      if (t.bytesReceived) {
                        r = 0;
                        if (t.bytesReceived) {
                          i.internal.audio[n].prevBytesReceived ||
                            (i.internal.audio[n].prevBytesReceived = t.bytesReceived);
                          o = t.bytesReceived - i.internal.audio[n].prevBytesReceived;
                          (i.internal.audio[n].prevBytesReceived = t.bytesReceived), (r = o / 1024);
                        }
                        (t.availableBandwidth = r.toFixed(1)),
                          (i.audio[n].availableBandwidth = t.availableBandwidth);
                      }
                      i.audio[n].tracks.indexOf(t.googTrackId) === -1 &&
                        i.audio[n].tracks.push(t.googTrackId);
                    }
                  }),
                  (r.checkVideoTracks = function(e) {
                    if (
                      e.googCodecName &&
                      e.mediaType === 'video' &&
                      t.indexOf(e.googCodecName.toLowerCase()) !== -1
                    ) {
                      const n = e.id.split('_').pop();
                      if (
                        (i.video[n].codecs.indexOf(e.googCodecName) === -1 &&
                          i.video[n].codecs.push(e.googCodecName),
                        e.bytesSent)
                      ) {
                        var r = 0;
                        i.internal.video[n].prevBytesSent ||
                          (i.internal.video[n].prevBytesSent = e.bytesSent);
                        var o = e.bytesSent - i.internal.video[n].prevBytesSent;
                        (i.internal.video[n].prevBytesSent = e.bytesSent), (r = o / 1024);
                      }
                      if (e.bytesReceived) {
                        r = 0;
                        i.internal.video[n].prevBytesReceived ||
                          (i.internal.video[n].prevBytesReceived = e.bytesReceived);
                        o = e.bytesReceived - i.internal.video[n].prevBytesReceived;
                        (i.internal.video[n].prevBytesReceived = e.bytesReceived), (r = o / 1024);
                      }
                      (e.availableBandwidth = r.toFixed(1)),
                        (i.video[n].availableBandwidth = e.availableBandwidth),
                        e.googFrameHeightReceived &&
                          e.googFrameWidthReceived &&
                          ((i.resolutions[n].width = e.googFrameWidthReceived),
                          (i.resolutions[n].height = e.googFrameHeightReceived)),
                        e.googFrameHeightSent &&
                          e.googFrameWidthSent &&
                          ((i.resolutions[n].width = e.googFrameWidthSent),
                          (i.resolutions[n].height = e.googFrameHeightSent)),
                        i.video[n].tracks.indexOf(e.googTrackId) === -1 &&
                          i.video[n].tracks.push(e.googTrackId);
                    }
                  }),
                  (r.bweforvideo = function(e) {
                    e.type === 'VideoBwe' &&
                      (i.video.bandwidth = {
                  ...
                  (r.googCandidatePair = function(e) {
                    if (
                      ...
                      const n = i.internal.candidates[e.remoteCandidateId];
                      n && n.ipAddress && (i.connectionType.systemIpAddress = n.ipAddress);
                    }
                  }),
                  (r.localcandidate = function(e) {
                  ...
                  (r.remotecandidate = function(e) {
                    e.type === 'remotecandidate' &&
                      ...
                      e.networkType && p.indexOf(e.networkType) === -1 && p.push(e.networkType),
                      (i.internal.candidates[e.id] = {
                        candidateType: u,
                        ipAddress: l,
                        portNumber: e.portNumber,
                      ...
                      (i.connectionType.remote.networkType = p),
                      (i.connectionType.remote.transport = d));
                  }),
                  (r.dataSentReceived = function(e) {
                    !e.googCodecName ||
                  ...
                  (r.ssrc = function(e) {
                    if (
                      ...
                      n[e.mediaType][t].indexOf(e.ssrc) === -1 && n[e.mediaType][t].push(e.ssrc),
                        (i[e.mediaType][t].streams = n[e.mediaType][t].length);
                    }
                  });
              },
            },
            ...
            },
            {
              ...
              value(e) {
                ...
                const n = (this.mediaStreamTrack, this.statsParser);

                const r = this.statsResult;
                e.forEach(e => {
                ...
                !0 === this.nomore &&
                  (r.datachannel && (r.datachannel.state = 'close'), (r.ended = !0)),
                  (r.results = e),
                  this.emit('stats', r);
              },
            },
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        _createLocalDescription(e, t) {
          ...
          let S = void 0;
          try {
            for (var b, C = this._mids[Symbol.iterator](); !(g = (b = C.next()).done); g = !0) {
              const _ = b.value;

              const T = (0, r.default)(_, 2);
          ...
          function k(e, r) {
            ...
            if (
              ...
              let C = void 0;
              try {
                for (var _, T = c.codecs[Symbol.iterator](); !(S = (_ = T.next()).done); S = !0) {
                  const R = _.value;
                  if (!R.kind || R.kind === r) {
                    ...
                    if (
                      ...
                      try {
                        for (
                          var I, A = Object.keys(R.parameters)[Symbol.iterator]();
                          !(E = (I = A.next()).done);
                          E = !0
                        ) {
                          const x = I.value;
                          k.config && (k.config += ';'), (k.config += `${x}=${R.parameters[x]}`);
                        }
                      } catch (e) {
                        (P = !0), (O = e);
                      } finally {
              ...
              let B = void 0;
              try {
                for (var G, H = u.values()[Symbol.iterator](); !(U = (G = H.next()).done); U = !0) {
                  const W = G.value;
                  ...
                  const K = Y.track;
                  if (K.readyState !== 'ended' && K.kind === r) {
                    W.ssrc || (W.ssrc = this.randomSSRC());
                    const J = d && K.kind === 'video';
                    J && !W.rtxSsrc && (W.rtxSsrc = W.ssrc + 1),
                      a.ssrcs.push({ attribute: 'cname', id: W.ssrc, value: CNAME }),
                      a.ssrcs.push({ attribute: 'msid', id: W.ssrc, value: `${z} ${K.id}` }),
                      a.ssrcs.push({ attribute: 'mslabel', id: W.ssrc, value: z }),
                      a.ssrcs.push({ attribute: 'label', id: W.ssrc, value: K.id }),
                      J &&
                        (a.ssrcs.push({ attribute: 'cname', id: W.rtxSsrc, value: CNAME }),
                        a.ssrcs.push({ attribute: 'msid', id: W.rtxSsrc, value: `${z} ${K.id}` }),
                        a.ssrcs.push({ attribute: 'mslabel', id: W.rtxSsrc, value: z }),
                        a.ssrcs.push({ attribute: 'label', id: W.rtxSsrc, value: K.id }),
                        a.ssrcGroups.push({ semantics: 'FID', ssrcs: `${W.ssrc} ${W.rtxSsrc}` }));
                  }
                }
              } catch (e) {
                (F = !0), (B = e);
              ...
              try {
                for (
                  ...
                  const ee = X.value;
                  (ee.kind && ee.kind !== r) || a.ext.push({ value: ee.preferredId, uri: ee.uri });
                }
              } catch (e) {
                (q = !0), ($ = e);
              } finally {
        ...
        removePayloadTypeFromMline(e, t) {
          e = e.split(' ');
          for (let n = 0; n < e.length; ++n) e[n] === t.toString() && e.splice(n, 1);
          return e.join(' ');
        },
        removeCodecByName(e, t) {
          const n = this.findLine(e, 'a=rtpmap', t);
          if (n === null) return e;
          const r = this.getCodecPayloadTypeFromLine(e[n]);
          e.splice(n, 1);
          const i = this.findLine(e, 'm=', 'video');
          return i === null ? e : ((e[i] = this.removePayloadTypeFromMline(e[i], r)), e);
        },
        removeCodecByPayloadType(e, t) {
          const n = this.findLine(e, 'a=rtpmap', t.toString());
          if (n === null) return e;
          e.splice(n, 1);
          const r = this.findLine(e, 'm=', 'video');
          return r === null ? e : ((e[r] = this.removePayloadTypeFromMline(e[r], t)), e);
        },
        maybeRemoveVideoFec(e, t) {
          if (t.videoFec !== 'false') return e;
          let n = e.split('\r\n');

          let r = this.findLine(n, 'a=rtpmap', 'red');
          if (r === null) return e;
          const i = this.getCodecPayloadTypeFromLine(n[r]);
          if (
            ((n = this.removeCodecByPayloadType(n, i)),
            (n = this.removeCodecByName(n, 'ulpfec')),
            (r = this.findLine(n, 'a=fmtp', i.toString())) === null)
          )
            return e;
          const o = this.parseFmtpLine(n[r]).pt;
          return o === null
            ? e
        ...
        maybePreferCodec(e, t, n, r) {
          const i = `${t} ${n} codec`;
          if (!r) return console.log(`No preference on ${i}.`), e;
          console.log(`Prefer ${i}: ${r}`);
          const o = e.split('\r\n');

          const a = this.findLine(o, 'm=', t);
          if (a === null) return e;
          const s = this.getCodecPayloadType(o, r);
          return (
            s
              ? (o[a] = this.setDefaultCodec(o[a], s))
              : console.error('no prefered codec found for ', r),
            (e = o.join('\r\n'))
          );
        },
        setCodecParam(e, t, n, r) {
          const i = e.split('\r\n');
        ...
        removeCodecParam(e, t, n) {
          const r = e.split('\r\n');

          const i = this.findFmtpLine(r, t);
          if (i === null) return e;
          const o = this.parseFmtpLine(r[i]);
          delete o.params[n];
          const a = this.writeFmtpLine(o);
          return a === null ? r.splice(i, 1) : (r[i] = a), (e = r.join('\r\n'));
        },
        parseFmtpLine(e) {
          const t = {};
        ...
        writeFmtpLine(e) {
          ...
          let i = 0;
          for (const o in n) (r[i] = `${o}=${n[o]}`), ++i;
          return i === 0 ? null : `a=fmtp:${t.toString()} ${r.join('; ')}`;
        },
        findFmtpLine(e, t) {
          const n = this.getCodecPayloadType(e, t);
          return n ? this.findLine(e, `a=fmtp:${n.toString()}`) : null;
        },
        findLine(e, t, n) {
          return this.findLineInRange(e, 0, -1, t, n);
        },
        findLineInRange(e, t, n, r, i) {
          for (let o = n !== -1 ? n : e.length, a = t; a < o; ++a)
            if (e[a].indexOf(r) === 0 && (!i || e[a].toLowerCase().indexOf(i.toLowerCase()) !== -1))
              return a;
          return null;
        },
        ...
        setDefaultCodec(e, t) {
          ...
          const r = n.slice(0, 3);
          r.push(t);
          for (let i = 3; i < n.length; i++) n[i] !== t && r.push(n[i]);
          return r.join(' ');
        },
      }),
        (e.exports = t.default);
    ...
    function(e, t, n) {
      ...
      const i = function(e, t, n) {
        ...
        !(function(e, t, n, i) {
          if (i && !n) t[i] = r(e[1]);
          else for (let o = 0; o < n.length; o += 1) e[o + 1] != null && (t[n[o]] = r(e[o + 1]));
        ...
        return (
          e
            ...
            .forEach(e => {
              ...
              const a = e.slice(2);
              t === 'm' && (n.push({ rtp: [], fmtp: [] }), (r = n[n.length - 1]));
    ...
    function(e, t, n) {
      ...
      (t.default = {
        init(e) {
          (o = r.default.checkVersion()), (s = e || window.console);
        },
        fnShake(e) {
          const t = this;
          ...
          if (n)
            return (
              ...
              a[i.id] &&
                a[i.id][n] &&
                (s.log(`destroy ${n} timer`), clearTimeout(a[i.id][n]), (a[i.id][n] = null)),
              s.log(`create ${n} timer`),
              new Promise((r, o) => {
                a[i.id][n] = setTimeout(() => {
                  (a[i.id][n] = null), r(t[n](e));
                }, 200);
              })
            );
        },
            ...
            h.media &&
              h.media.map((t, i) => {
                if (
                  ...
                  (t.direction =
                    c !== r ? 'recvonly' : /recvonly/.test(t.direction) ? 'recvonly' : 'sendonly'),
                  ((/audio/.test(t.type) && !m) || (/video/.test(t.type) && !v)) &&
                    delete t.ssrcs &&
                    delete t.ssrcGroups &&
                    delete t.msid,
                  t.type === 'audio' && (f.push(t.mid), t),
                  t.type === 'video' &&
                    v &&
                    t.ssrcs.map(e => {
                      /^label$/.test(e.attribute) && e.value !== v.id && p.push(e.id);
                    }),
                  t.type === 'audio' &&
                ...
                if (n.type === 'offer') {
                  ...
                  h.groups &&
                    h.groups.map(e => {
                      ...
                      n.indexOf(l) !== -1 &&
                        (n.splice(n.indexOf(l), 1, t.mid), (e.mids = n.join(' ')));
                    });
                }
        ...
        formatSSRCChrome(e, t, n) {
          return e.map((e, r) => {
            return (e.id = `${t}0${n}0${Math.floor(r / 4)}`), (e.id -= 0), e;
          });
        },
        formatSSRCFirefox(e, t, n) {
          return e.map((e, r) => {
            return (e.id = `${t}0${n}0${Math.floor(r / 4)}`), (e.id -= 0), e;
          });
        },
        ...
        formatSdpRemoteChrome(e) {
          return (
            (e = e.replace(/a=msid:.+\r\na=ssrc:\d+ cname:.+/gi, (e, t) => {
              const n = e.match(/a=ssrc:(\d+)/);

              const r = e.match(/a=msid:(.+) (.+)/);
              return (
                n[1] && (e = e.replace('a=msid', `a=ssrc:${n[1]} msid`)),
                r[1] && n[1] && (e = `${e}\r\na=ssrc:${n[1]} mslabel:${r[1]}`),
                r[2] && n[1] && (e = `${e}\r\na=ssrc:${n[1]} label:${r[2]}`),
                e
              );
            })),
            s.log('formated: \n', e),
          ...
          return (
            ...
            d &&
              d.map(e => {
                ...
                const n = o.tracks[e].track;
                s.warn('remove old track', t, n), u.removeTrack(n), c.removeTrack(t);
              }),
            l &&
              l.map(e => {
                const t = a[e];
        ...
        checkCurrStream(e) {
          ...
          return (
            r.map(e => {
              const r = e.track;
              r
                ? ((t[r.id] = { sender: e, track: r }),
                  s.log(' --\x3e track id:', `${r.kind}:${r.id}`))
                : n.push(e);
            }),
            { tracks: t, empty: n }
          );
        ...
        checkMediaStatus() {
          ...
          return (
            ...
            (a.audio = u && u.readyState !== 'ended' && new RegExp(u.id).test(r)),
            (a.video = d && d.readyState !== 'ended' && new RegExp(d.id).test(r)),
            a
          );
        },
        validMediaStream() {
              ...
              },
              {
                ...
                value() {
                  ...
                  document.body.appendChild(n),
                    ...
                    (n.href = t),
                    (n.download = `${this.fileName || Date.now()}.webm`),
                    n.click(),
      ...
      (l.init = function() {
        if (
          ...
          navigator.mediaDevices.ondevicechange = function(n) {
            ...
            const r = Object.assign({}, t.devicesCache);
            e = setTimeout(() => {
              (e = null),
                t
                  .getDevices(!0)
                        ...
                        for (;;)
                          switch ((r.prev = r.next)) {
                            ...
                            case 2:
                              ...
                              return r.abrupt('return', o('没有找到可用设备'));
                            case 5:
    ...
    function(e, t, n) {
      const r = n(10);
      e.exports = function(e, t, n) {
        for (const i in t) n && e[i] ? (e[i] = t[i]) : r(e, i, t[i]);
        return e;
      };
    },
    function(e, t, n) {
      const r = n(1).navigator;
    ...
    function(e, t, n) {
      ...
      const A = !!(function() {
        try {
          ...
          const t = ((e.constructor = {})[n(2)('species')] = function(e) {
            e(O, O);
          });
          return (
    ...
    function(e, t, n) {
      n(72), n(51), n(60), n(258), n(250), n(249), (e.exports = n(3).Promise);
    },
    function(e, t, n) {
    ...
    function(e, t) {
      !(function(t) {
        ...
        if (d) u && (e.exports = d);
          ...
          const S = (R.prototype = _.prototype = Object.create(v));
            ...
            (I.prototype = {
              ...
              reset(e) {
                if (
                  ...
                  for (const t in this)
                    t.charAt(0) === 't' && i.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = n);
              },
              stop() {
                this.done = !0;
        ...
        function b(e, t, n, r) {
          const i = t && t.prototype instanceof _ ? t : _;
            ...
            (o._invoke = (function(e, t, n) {
              ...
              return function(i, o) {
                ...
                for (n.method = i, n.arg = o; ; ) {
                  ...
                  c.type === 'throw' && ((r = h), (n.method = 'throw'), (n.arg = c.arg));
                }
              };
            })(e, n, a)),
            o
        ...
        function E(e, t) {
          ...
          if (r === n) {
            if (((t.delegate = null), t.method === 'throw')) {
              if (
                e.iterator.return &&
                ((t.method = 'return'), (t.arg = n), E(e, t), t.method === 'throw')
              )
                return m;
              (t.method = 'throw'),
    ...
    function(e, t, n) {
      ...
      const o = i && r.regeneratorRuntime;
      if (((r.regeneratorRuntime = void 0), (e.exports = n(261)), i)) r.regeneratorRuntime = o;
      else
        try {
    ...
    function(e, t, n) {
      ...
      const S = (function(e) {
        function t(e) {
          (0, r.default)(this, t);
          const n = (0, o.default)(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
          return (n.logger = e.logger || {}), n.resetStatus(), n.init(), n;
        }
        return (
          (0, a.default)(t, e),
          (0, i.default)(t, [
            ...
            },
            {
              ...
              value() {
                ...
                const n = u.constantTool.getVideoSessionConfig({
                  quality: this.sessionConfig.videoQuality,
                  frameRate: this.sessionConfig.videoFrameRate,
                });
                return (
                  (this.imInfo = Object.assign(this.imInfo, { videoConfig: n })),
                  this._startSession()
                    .then(t => {
                      return e.rtcLogin();
                    })
                    .then(t => {
                      ...
                      const n = e.mediaDevices.getDeviceStatus();

                      const r = (e.deviceAudioStatus && n.hasAudio && !e.imInfo.role) || !1;

                      const i = (e.deviceVideoStatus && n.hasVideo && !e.imInfo.role) || !1;
                      console.log('this.deviceAudioStatus', e.deviceAudioStatus),
                        console.log('deviceStatus.hasAudio', n.hasAudio),
                ...
                return (
                  ...
                  new Promise((t, n) => {
                    e.once('LoginSuccess', n => {
                      e.logger.log('once LoginSuccess--\x3e', n), t();
                    }),
            ...
            },
            {
              ...
              value(e) {
                ...
                const n = this.imInfo.sessionMode;
                return this.createOffer(e)
                  .then(() => {
                    return new Promise((e, r) => {
                      t.once('sessionConnected', n => {
            ...
            },
            {
              key: 'sendMsg',
              value(e, t) {
                let n = { type: e, uid: `${this.imInfo.uid}`, cid: `${this.imInfo.cid}` };
                this.sessionDuration(e),
                  (n = Object.assign(n, t)),
                  this.signal && this.logger.log(`webrtc-controller::sendMsg ---\x3e ${e}`, n),
            ...
            },
            {
              ...
              value(e) {
                ...
                const i = n.has_audio;
                if (
                  (this.emit('remoteStreamUpdate', { uid: t, audio: i, video: r }),
                  this.remoteNode[t])
                )
                  return y.prefix === 'Firefox' && y.version - 0 >= 59
                    ? this._delayVideoShow(t, r)
                    : this._onclient_update(t, r);
                (!i && !r) || this.remoteNode[t] || this._onclient_join(t);
              },
            },
            {
              ...
              value(e, t) {
                if (this.remoteNode[e]) {
                  const n = this.remoteNode[e].rtc;
                  n && (t ? this.createOffer({ rtc: n }) : this.delayVideoShow(e, t));
            ...
            },
            {
              ...
              value(e) {
                ...
                const r = e.cid;
                this.emit('leaveChannel', { uid: n, cid: r, type: t }),
                  this.remoteNode.hasOwnProperty(n) &&
                    (this.destroyRemoteNode(n),
                    this.removeRemoteUserStream(n),
                    this.rtcRecorder && this.rtcRecorder.leave({ uid: n }));
              },
            },
            {
              ...
              value() {
                ...
                e ||
                  (e = this.audioMonitorTimer = setInterval(() => {
                    ...
                    for (const r in n) {
                      const i = this.info.client.getAccountWithUid(r);
                      (t =
                        n[r] && n[r].remoteAudioStream
                          ? n[r].remoteAudioStream.getAudioVolume()
                          : 0),
                        (e[i || r] = { status: t });
                    }
    ...
    function(e, t, n) {
      ...
      const i = {
        ...
        hangup: { sid: 9, cid: r.netcall.hangup, params: [{ type: 'long', name: 'channelId' }] },
        netcallControl: {
          sid: 9,
          cid: r.netcall.netcallControl,
          params: [{ type: 'long', name: 'channelId' }, { type: 'byte', name: 'type' }],
        },
        verifyChannelId: {
          sid: 9,
          cid: r.netcall.verifyChannelId,
          params: [{ type: 'long', name: 'channelId' }, { type: 'String', name: 'account' }],
        },
        createChannel: {
          sid: 9,
          cid: r.netcall.createChannel,
          params: [
        ...
        queryAccountUidMap: {
          sid: 9,
          cid: r.netcall.queryAccountUidMap,
      ...
      e.exports = { idMap: r, cmdConfig: i, packetConfig: o };
    },
    function(e, t, n) {
      const r = {
        install(e) {
              ...
              i &&
                ...
                setTimeout(() => {
                  t.currentNetcallChannelId &&
                    ...
                    t.api.keepCalling({ type: r, accounts: i, channelId: o }).catch(() => {});
                }, 3e3);
            }),
    ...
    function(e, t, n) {
      ...
      (t.default = {
        createChannel() {
          ...
          const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          return (
            i.tool.verifyOptions(t, 'channelName'),
            (t.custom = t.custom || ''),
            (t.webrtcEnable = !0),
            this.controller.uploadDataApi('update', { key: 'meeting' }),
            this.setSessionConfig({ signalStartTime: Date.now() }),
            this.baseCreateChannel('createChannel', t)
              .then(e => {
                return Promise.resolve(e);
              })
              .catch(t => {
                return (
                  e.setSessionConfig({ signalEndTime: Date.now() }),
                  e.controller.uploadDataRtcOnce({ code: t.code }),
                  Promise.reject(t)
                );
              })
          );
        ...
        joinChannel() {
          ...
          i.tool.verifyOptions(t, 'channelName type');
          const n = t.sessionConfig;

          const o = void 0 === n ? {} : n;
          if (
            ((o.liveEnable = t.liveEnable || o.liveEnable),
            i.tool.merge(this, { sessionConfig: o }),
            this.setSessionConfig(o),
            this.setSessionConfig({ signalStartTime: Date.now() }),
            this.controller.uploadDataApi('update', { key: 'meeting' }),
            t.liveEnable &&
              this.controller.uploadDataApi('update', {
                key: 'bypass',
                ext: void 0 !== o.splitMode ? +o.splitMode + 1 : 0,
              }),
            o.highAudio && this.controller.uploadDataApi('update', { key: 'hd_audio' }),
            void 0 !== o.videoFrameRate &&
              this.controller.uploadDataApi('update', {
                key: 'fps',
                ext: +o.videoFrameRate == 0 ? 0 : +o.videoFrameRate + 1,
              }),
            void 0 !== o.videoQuality)
          ) {
            let a = +o.videoQuality;
            a === r.constantRtc.CHAT_VIDEO_QUALITY_540P
              ? (a = r.constantRtc.CHAT_VIDEO_QUALITY_720P)
              : a === r.constantRtc.CHAT_VIDEO_QUALITY_720P &&
                (a = r.constantRtc.CHAT_VIDEO_QUALITY_540P),
              this.controller.uploadDataApi('update', { key: 'video_quality', ext: a || 0 });
          }
          return this.baseJoinChannel('joinChannel', {
            channelName: t.channelName,
            liveEnable: t.liveEnable,
          })
            .then(n => {
              return (
                console.log('joinChannel', n),
                (e.type = n.type = t.type),
                (n.account = e.nim.account),
                (e.imInfo = n),
                (e.imInfo.role = void 0 === t.role ? 0 : t.role),
                (e.channelId = n.channelId),
                e.controller.uploadDataApi('start', { uid: n.uid }),
                Promise.resolve({
                  uid: n.uid,
                  account: e.nim.account,
                  type: n.type,
                  custom: n.custom,
                })
              );
            ...
            .catch(t => {
              return e.controller.uploadDataRtcOnce({ code: t.code }), Promise.reject(t);
            });
        },
        leaveChannel() {
          return this.signalInited && this.sessionMode
            ? this.sessionMode !== 'meeting'
              ? Promise.reject({ code: 'not in a meeting' })
              : (this.controller.uploadDataApi('send'),
    ...
    function(e, t, n) {
      ...
      s.default.CURRENT.SDK_TYPE = s.default.SDK_TYPE.WEBRTC;
      const v = (function(e) {
        function t(e) {
          (0, r.default)(this, t);
          const n = (0, o.default)(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
          ...
          (0, i.default)(t, [
            {
              key: 'initWR',
              value() {
                this.nim || this.logger.error('webrtc-client::initWR: 请传入nim实例'),
                  this.initProtocol(),
                  this.initController(),
                  (this.devices = { hasAudio: !1, hasVideo: !1 });
              },
            },
            {
              key: 'destroy',
            ...
            },
            {
              key: 'resetWhenHangup',
              value() {
                this.controller.stopSession(), this.resetStatus();
              },
            },
            {
              key: 'initSignal',
            ...
            },
            {
              ...
              value() {
                ...
                e.on('beCalled', this.onBeCalled.bind(this)),
                  ...
                  e.on('netcallControl', this.onControl.bind(this)),
            ...
            },
            {
              ...
              value() {
                const e = this;
                (window.myContrl = this.controller = new d.default({
                  ...
                  this.controller.on('remoteSignalClosed', t => {
                    e.emit('remoteSignalClosed', { uid: t, account: e.getAccountWithUid(t) });
                  }),
                  ...
                  this.controller.on('remoteTrack', t => {
                    e.emit('remoteTrack', {
                      ...
                      track: t.track,
                      type: t.track.kind,
                      account: e.getAccountWithUid(t.uid),
                    });
                  }),
                  this.controller.on('remoteStreamUpdate', t => {
                    (t.account = e.getAccountWithUid(t.uid)), e.emit('remoteStreamUpdate', t);
                  }),
            ...
            },
            {
              ...
              value() {
                ...
                if (
                  ...
                  (this.callee = t),
                  (this.target.account = t),
                  this.setSessionConfig(i),
                  this.setSessionConfig({ signalStartTime: Date.now() }),
                  this.controller.uploadDataApi('update', { key: 'p2p' }),
                  i.highAudio && this.controller.uploadDataApi('update', { key: 'hd_audio' }),
                  void 0 !== i.videoFrameRate &&
                    this.controller.uploadDataApi('update', {
                      key: 'fps',
                      ext: +i.videoFrameRate == 0 ? 0 : +i.videoFrameRate + 1,
                    }),
                  r.forceKeepCalling &&
                    this.controller.uploadDataApi('update', { key: 'always_keep_calling' }),
                  void 0 !== i.videoQuality)
                ) {
                  let o = +i.videoQuality;
                  o === c.constantRtc.CHAT_VIDEO_QUALITY_540P
                    ? (o = c.constantRtc.CHAT_VIDEO_QUALITY_720P)
                    : o === c.constantRtc.CHAT_VIDEO_QUALITY_720P &&
                      (o = c.constantRtc.CHAT_VIDEO_QUALITY_540P),
                    this.controller.uploadDataApi('update', {
                      key: 'video_quality',
                ...
                return this.initNetcall({ type: n, pushConfig: r });
              },
            },
            {
              key: 'initNetcall',
                ...
                return (
                  ...
                  this.nim
                    ...
                    .then(t => {
                      (e.signalInited = !0),
                        (e.sessionMode = 'p2p'),
                        e.logger.log('webrtc-client::initNetcall:', t),
                        (e.callerInfo = t),
            ...
            },
            {
              ...
              value() {
                ...
                const t = e.sessionConfig;

                const n = void 0 === t ? {} : t;
                if (
                  (this.controller.uploadDataApi('update', { key: 'p2p' }),
                  n.highAudio && this.controller.uploadDataApi('update', { key: 'hd_audio' }),
                  void 0 !== n.videoFrameRate &&
                    this.controller.uploadDataApi('update', {
                      key: 'fps',
                      ext: +n.videoFrameRate == 0 ? 0 : +n.videoFrameRate + 1,
                    }),
                  void 0 !== n.videoQuality)
                ) {
                  let r = +n.videoQuality;
                ...
                return (e.fn = 'calleeAck'), this.baseResponse(e);
              },
            },
            {
              key: 'control',
              value() {
                const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return (e.fn = 'netcallControl'), this.baseControl(e);
              },
            },
            {
              key: 'hangup',
              value() {
                const e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                (e.fn = 'hangup'), (e.recordType = 'cancelNetcallBeforeAccept'), this.baseHangup(e);
              },
            },
            {
              key: 'onBeCalled',
              ...
              value() {
                ...
                return this.calling
                  ...
                  : ((this.signalInited = !0),
                    ...
                    (this.imInfo = e),
                    (this.imInfo.serverAddrs = e.rtcServerMap),
                    (this.imInfo.rtcUrls = e.rtcServerMap),
                    (this.beCalledInfo = this.imInfo),
                    this.imInfo.sessionConfig && this.setSessionConfig(this.imInfo.sessionConfig),
            ...
            },
            {
              key: 'stopSession',
              value() {
                return this.controller.stopSession();
              },
            },
          ]),
          t
    ...
    function(e, t, n) {
      ...
      const m = h.info.nrtcVersion;

      const v = h.info.version;

      let g = void 0;

      const y = (0, r.default)(
        { version: v, versionRtc: m },
        o.constantRtc,
        a.RtcSupport,
        s.default,
        {
          install(e, t) {
            u.install(e, t),
              d.install(e, t),
              e.parser.mixin({ configMap: l, serializeMap: p, unserializeMap: f });
          },
          getInstance(e) {
            return g || (g = new i.default(e)), g;
          },
          destroy() {
            g && (g.destroy(), (g = null));
          },

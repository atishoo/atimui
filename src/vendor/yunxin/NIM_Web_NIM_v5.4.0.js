  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      (o.deduplicate = function(e) {
        ...
        (o.filterObj = function(e, t) {
          const n = {};
          return (
            o.isString(t) && (t = t.split(c)),
            t.forEach(t => {
        ...
        (o.copyWithNull = function(e, t) {
          return (
            (t = t || {}),
            e
              ? (Object.keys(e).forEach(n => {
                  (o.exist(e[n]) || o.isnull(e[n])) && (t[n] = e[n]);
                }),
                t)
              : t
          );
        }),
        (o.findObjIndexInArray = function(e, t) {
          e = e || [];
          ...
          return (
            e.some((e, s) => {
              if (i(e, n) === t.value) return (r = s), !0;
            }),
            r
          );
        }),
        (o.findObjInArray = function(e, t) {
          const n = o.findObjIndexInArray(e, t);
          return n === -1 ? null : e[n];
        }),
        (o.mergeObjArray = function() {
          let e = [];

          const t = [].slice.call(arguments, 0, -1);

          let n = arguments[arguments.length - 1];
          o.isArray(n) && (t.push(n), (n = {}));
          let r;
          ...
          return (
            t.forEach(t => {
              t &&
                t.forEach(t => {
                  (r = o.findObjIndexInArray(e, { keyPath: s, value: i(t, s) })) !== -1
                    ? (e[r] = o.merge({}, e[r], t))
                    : e.push(t);
                });
            }),
            n.notSort || (e = o.sortObjArray(e, n)),
            e
          );
        }),
        (o.cutObjArray = function(e) {
          const t = e.slice(0);
            ...
            r.forEach(e => {
              o.isArray(e) || (e = [e]),
                e.forEach(e => {
                  e &&
                    ((s.value = i(e, c)),
                    (a = o.findObjIndexInArray(t, s)) !== -1 && t.splice(a, 1));
                });
            }),
            t
          );
        }),
        (o.sortObjArray = function(e, t) {
          ...
          const u = !!t.desc;
          return (
            (c = o.isFunction(t.compare)
              ? t.compare
              : function(e, t) {
                  return (r = i(e, n)), (a = i(t, n)), u ? s(a, r) : s(r, a);
                }),
            e.sort(c)
          );
        }),
        (o.emptyFunc = function() {}),
        (o.isEmptyFunc = function(e) {
          return e === o.emptyFunc;
        }),
        (o.notEmptyFunc = function(e) {
          return e !== o.emptyFunc;
        }),
        (o.splice = function(e, t, n) {
          return [].splice.call(e, t, n);
        }),
        (o.reshape2d = function(e, t) {
          if (Array.isArray(e)) {
            o.verifyParamType('type', t, 'number', 'util::reshape2d');
            const n = e.length;
            if (n <= t) return [e];
        ...
        (o.dropArrayDuplicates = function(e) {
          if (Array.isArray(e)) {
        ...
        (o.verifyParamPresent = function(e, t, n, r) {
          n = n || '';
          let s = !1;
          switch (o.typeOf(t)) {
            case 'undefined':
            ...
            case 'array':
              t.length
                ? t.some(e => {
                    if (o.notexist(e)) return (s = !0), !0;
                  })
                : (s = !0);
          }
          s && o.onParamAbsent(n + e, r);
        }),
        (o.onParamAbsent = function(e, t) {
          o.onParamError(
            `缺少参数 ${e}, 请确保参数不是 空字符串、空对象、空数组、null或undefined, 或数组的内容不是 null/undefined`,
            t
          );
        }),
        (o.verifyParamAbsent = function(e, t, n, r) {
          (n = n || ''), void 0 !== t && o.onParamPresent(n + e, r);
        }),
        (o.onParamPresent = function(e, t) {
          o.onParamError(`多余的参数 ${e}`, t);
        }),
        (o.verifyParamType = function(e, t, n, r) {
          const s = o.typeOf(t).toLowerCase();
          o.isArray(n) || (n = [n]);
          let i = !0;
          switch (
            ((n = n.map(e => {
          ...
          i || o.onParamInvalidType(e, n, '', r);
        }),
        (o.onParamInvalidType = function(e, t, n, r) {
          (n = n || ''),
            (t = o.isArray(t)
              ? (t = t.map(e => {
                  return `"${e}"`;
              ...
              : `"${t}"`),
            o.onParamError(`参数"${n}${e}"类型错误, 合法的类型包括: [${t}]`, r);
        }),
        (o.verifyParamValid = function(e, t, n, r) {
          o.isArray(n) || (n = [n]), n.indexOf(t) === -1 && o.onParamInvalidValue(e, n, r);
        }),
        (o.onParamInvalidValue = function(e, t, n) {
          o.isArray(t) || (t = [t]),
            (t = t.map(e => {
              return `"${e}"`;
            })),
            o.isArray(t) && (t = t.join(', ')),
            o.onParamError(`参数 ${e}值错误, 合法的值包括: [${JSON.stringify(t)}]`, n);
        }),
        (o.verifyParamMin = function(e, t, n, r) {
          t < n && o.onParamError(`参数${e}的值不能小于${n}`, r);
        }),
        (o.verifyParamMax = function(e, t, n, r) {
          t > n && o.onParamError(`参数${e}的值不能大于${n}`, r);
        }),
        (o.verifyArrayMax = function(e, t, n, r) {
          t.length > n && o.onParamError(`参数${e}的长度不能大于${n}`, r);
        }),
        (o.verifyEmail = (function() {
          const e = /^\S+@\S+$/;
        ...
        (o.verifyTel = (function() {
          const e = /^[+\-()\d]+$/;
          return function(t, n, r) {
            e.test(n) ||
              o.onParamError(`参数${t}电话号码格式错误, 合法字符包括+、-、英文括号和数字`, r);
          };
        })()),
        (o.verifyBirth = (function() {
          const e = /^(\d{4})-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$/;
          return function(t, n, r) {
            e.test(n) || o.onParamError(`参数${t}生日格式错误, 合法为"yyyy-MM-dd"`, r);
          };
        })()),
        (o.onParamError = function(e, t) {
          o.onError({ message: e, callFunc: t });
        }),
        (o.verifyOptions = function(e, t, n, r, s) {
          if (((e = e || {}), t && (o.isString(t) && (t = t.split(c)), o.isArray(t)))) {
            typeof n !== 'boolean' && ((s = n || null), (n = !0), (r = ''));
            const i = n ? o.verifyParamPresent : o.verifyParamAbsent;
            t.forEach(t => {
              i.call(o, t, e[t], r, s);
            });
          }
        ...
        (o.verifyParamAtLeastPresentOne = function(e, t, n) {
          t &&
            (o.isString(t) && (t = t.split(c)),
            o.isArray(t) &&
              (t.some(t => {
                ...
                o.onParamError(`以下参数[${t.join(', ')}]至少需要传入一个`, n)));
        }),
        (o.verifyParamPresentJustOne = function(e, t, n) {
          t &&
            (o.isString(t) && (t = t.split(c)),
            o.isArray(t) &&
              t.reduce((t, n) => {
                return o.exist(e[n]) && t++, t;
              }, 0) !== 1 &&
              o.onParamError(`以下参数[${t.join(', ')}]必须且只能传入一个`, n));
        }),
        (o.verifyBooleanWithDefault = function(e, t, n, r, s) {
          o.undef(n) && (n = !0),
            c.test(t) && (t = t.split(c)),
            o.isArray(t)
              ? t.forEach(t => {
                  o.verifyBooleanWithDefault(e, t, n, r, s);
                })
              : void 0 === e[t]
                ? (e[t] = n)
                : o.isBoolean(e[t]) || o.onParamInvalidType(t, 'boolean', r, s);
        }),
        (o.verifyFileInput = function(e, t) {
          return (
            o.verifyParamPresent('fileInput', e, '', t),
            o.isString(e) &&
              ((e = document.getElementById(e)) ||
                o.onParamError(`找不到要上传的文件对应的input, 请检查fileInput id ${e}`, t)),
        ...
        (o.verifyFileType = function(e, t) {
          o.verifyParamValid('type', e, o.validFileTypes, t);
        }),
        (o.verifyCallback = function(e, t, n) {
          c.test(t) && (t = t.split(c)),
            o.isArray(t)
              ? t.forEach(t => {
                  o.verifyCallback(e, t, n);
                })
              : e[t]
                ? o.isFunction(e[t]) || o.onParamInvalidType(t, 'function', '', n)
                : (e[t] = o.emptyFunc);
        }),
        (o.verifyFileUploadCallback = function(e, t) {
          o.verifyCallback(e, 'uploadprogress uploaddone uploaderror uploadcancel', t);
        }),
        (o.validFileTypes = ['image', 'audio', 'video', 'file']),
        (o.validFileExts = {
          image: ['bmp', 'gif', 'jpg', 'jpeg', 'jng', 'png', 'webp'],
          audio: ['mp3', 'wav', 'aac', 'wma', 'wmv', 'amr', 'mp2', 'flac', 'vorbis', 'ac3'],
          video: ['mp4', 'rm', 'rmvb', 'wmv', 'avi', 'mpg', 'mpeg'],
        }),
        (o.filterFiles = function(e, t) {
          let n;
          ...
          return (
            [].forEach.call(e, e => {
              if (s) i.push(e);
                ...
                (r[0].toLowerCase() === t || o.validFileExts[t].indexOf(n) !== -1) && i.push(e);
              }
            }),
            i
          );
        });
      const u = (o.supportFormData = o.notundef(a.FormData));
      (o.getFileName = function(e) {
        return (
          (e = o.verifyFileInput(e)),
          u ? e.files[0].name : e.value.slice(e.value.lastIndexOf('\\') + 1)
        );
      }),
        (o.getFileInfo = (function() {
          const e = { ppt: 1, pptx: 2, pdf: 3 };
          return function(t) {
            const n = {};
            if (!(t = o.verifyFileInput(t)).files) return n;
            const r = t.files[0];
            return (
              u &&
                ((n.name = r.name),
        ...
        (o.promises2cmds = function(e) {
          return e.map(e => {
            return e.cmd;
          });
        }),
        (o.objs2accounts = function(e) {
          return e.map(e => {
            return e.account;
          });
        }),
        (o.teams2ids = function(e) {
          return e.map(e => {
            return e.teamId;
          });
        }),
        (o.objs2ids = function(e) {
          return e.map(e => {
            return e.id;
          });
        }),
        (o.getMaxUpdateTime = function(e) {
          const t = e.map(e => {
            return +e.updateTime;
          });
          return Math.max(...t);
        }),
        (o.genCheckUniqueFunc = function(e, t) {
          return (
            (e = e || 'id'),
            (t = t || 1e3),
            function(t) {
        ...
        (o.fillPropertyWithDefault = function(e, t, n) {
          return !!o.undef(e[t]) && ((e[t] = n), !0);
        }),
        (e.exports = o);
    },
    function(e, t) {
    ...
    function(e, t, n) {
      ...
      t.default =
        typeof s.default === 'function' && i(r.default) === 'symbol'
          ? function(e) {
    ...
    function(e, t, n) {
      (function(t) {
        ...
        const s = (function() {
          ...
          function l(e, t) {
            for (const n in e) o.call(e, n) && t(e[n], n, e);
          }
          function m(e) {
          ...
          return (function t(n) {
            ...
            const b = o ? 'Object' : 'ScriptBridgingProxyObject';

            const M = o ? 'Object' : 'Environment';

            const T = o && i.java ? 'JavaPackage' : m(i.java);

            const k = o ? 'Object' : 'RuntimeObject';

            const S = /\bJava/.test(T) && i.java;

            const P = S && m(i.environment) == M;
            ...
            var x = s.test((x = o && O ? O['[[Class]]'] : m(O))) ? x : (O = null);
            ...
            let F = R && O && typeof O.version === 'function' && O.version();
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  try {
                    (F = i.require('ringo/engine').version.join('.')), (U = 'RingoJS');
                  } catch (e) {
                    (h = i.system) &&
                      h.global.system == i.system &&
                ...
                m((h = i.runtime)) == b
                  ...
                  : m((h = i.phantom)) == k
                    ...
                    : typeof w.documentMode === 'number' && (h = /\bTrident\/(\d+)/i.exec(n))
                      ? ((F = [F, w.documentMode]),
                        (h = +h[1] + 4) != F[1] &&
                          (_.push(`IE ${F[1]} mode`), j && (j[1] = ''), (F[1] = h)),
                        (F = U == 'IE' ? String(F[1].toFixed(1)) : F[0]))
                      : typeof w.documentMode === 'number' &&
            ...
            if (
              ...
              if (U == 'IE' && R)
                try {
                  i.external === null && _.unshift('platform preview');
                } catch (e) {
                  _.unshift('embedded');
                }
              else
    ...
    function(e, t, n) {
      ...
      [200, 406, 808, 810].forEach(e => {
        ...
        (s.noDBError = function(e) {
          return new s(i.NO_DB, 'NO_DB', e);
        }),
        (s.newDBError = function(e) {
          return new s(i.DB, 'DB', e);
        }),
    ...
    function(e, t, n) {
      (function(e) {
        ...
        t.format = (function() {
          ...
          const t = { yyyy: o, MM: a, dd: c, hh: u, mm: l, ss: m, SSS: d };
          return function(n, r) {
            return (
              (n = new Date(n)),
              isNaN(+n)
    ...
    function(e, t, n) {
      ...
      Object.create && ((i.prototype = Object.create(null)), new i().__proto__ || (s = !1)),
        ...
        (a.prototype.removeListener = function(e, t, n, r) {
          ...
          if (!t)
            return (
              --this._eventsCount == 0 ? (this._events = new i()) : delete this._events[o], this
            );
          ...
          if (a.fn)
            a.fn !== t ||
              (r && !a.once) ||
              (n && a.context !== n) ||
              (--this._eventsCount == 0 ? (this._events = new i()) : delete this._events[o]);
          else {
            for (var c = 0, u = [], l = a.length; c < l; c++)
              (a[c].fn !== t || (r && !a[c].once) || (n && a[c].context !== n)) && u.push(a[c]);
            u.length
              ? (this._events[o] = u.length === 1 ? u[0] : u)
              : --this._eventsCount == 0
                ? (this._events = new i())
    ...
    function(e, t, n) {
      ...
      const a = n(6).f;
      e.exports = function(e) {
        const t = s.Symbol || (s.Symbol = i ? {} : r.Symbol || {});
    ...
    function(e, t, n) {
      ...
      const i = s['__core-js_shared__'] || (s['__core-js_shared__'] = {});
      (e.exports = function(e, t) {
      ...
      var d = function(e, t, n, r, s) {
        ...
        n && (a = 'api::processCallbackPromise'),
          ...
          (e.callback = function(c, u, l) {
            ...
            if (((u = u || m), t && (u = m), i.isFunction(e.cbaop))) {
              const d = e.cbaop(c, u);
              o(d) && (u = d);
            }
            const p = e.done;
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, f, g, h, y) {
        ...
        const I = C[m] || C['@@iterator'] || (g && C[g]);

        let w = I || T(g);

        const O = g ? (S ? T('entries') : w) : void 0;

        const x = (t == 'Array' && C.entries) || I;
        if (
          (x &&
            (M = l(x.call(new e()))) !== Object.prototype &&
            M.next &&
            (u(M, k, !0), r || typeof M[m] === 'function' || o(M, m, p)),
          S &&
            I &&
            I.name !== 'values' &&
            ((P = !0),
          ...
          if (((v = { values: S ? w : T('values'), keys: h ? w : T('keys'), entries: O }), y))
            for (b in v) b in C || i(C, b, v[b]);
                ...
                (e.promise
                  ? e.promise.then(
                      ...
                      r => {
                        ...
                        const o = i.customError('CALLBACK_ACK_ERR', r);
                        t.logger.error(
    ...
    function(e, t, n) {
      ...
      function h(e) {
        ...
        (this.scene = m[e.scene]),
          ...
          o(e.body) && (this.body = `${e.body}`),
          o(e.pushContent) && (this.pushContent = `${e.pushContent}`),
          o(e.pushPayload) && (this.pushPayload = `${e.pushPayload}`);
        const t = e.apns;
        if (o(t) && e.scene === 'team') {
          const n = t.accounts;
          o(n) && s.verifyParamType('apns.accounts', n, 'array', 'msg::Message'),
        ...
        o(e.isHistoryable) && (this.isHistoryable = e.isHistoryable ? 1 : 0),
          o(e.isRoamingable) && (this.isRoamingable = e.isRoamingable ? 1 : 0),
          o(e.isSyncable) && (this.isSyncable = e.isSyncable ? 1 : 0),
          o(e.cc) && (this.cc = e.cc ? 1 : 0),
          o(e.isPushable) && (this.isPushable = e.isPushable ? 1 : 0),
          o(e.isOfflinable) && (this.isOfflinable = e.isOfflinable ? 1 : 0),
          o(e.isUnreadable) && (this.isUnreadable = e.isUnreadable ? 1 : 0),
          o(e.needPushNick) && (this.needPushNick = e.needPushNick ? 1 : 0),
          o(e.needMsgReceipt) && (this.needMsgReceipt = e.needMsgReceipt ? 1 : 0),
          o(e.yidunEnable) && (this.yidunEnable = e.yidunEnable ? 1 : 0),
          o(e.antiSpamUsingYidun) && (this.antiSpamUsingYidun = e.antiSpamUsingYidun ? 1 : 0),
          o(e.clientAntiSpam) && (this.clientAntiSpam = e.clientAntiSpam ? 1 : 0),
          o(e.antiSpamContent) &&
      ...
      s.merge(h.prototype, u.prototype),
        ...
        (h.reverse = function(e) {
          const t = {
            ...
            isHistoryable: i(e.isHistoryable) || +e.isHistoryable == 1,
            isRoamingable: i(e.isRoamingable) || +e.isRoamingable == 1,
            isSyncable: i(e.isSyncable) || +e.isSyncable == 1,
            cc: i(e.cc) || +e.cc == 1,
            isPushable: i(e.isPushable) || +e.isPushable == 1,
            isOfflinable: i(e.isOfflinable) || +e.isOfflinable == 1,
            isUnreadable: i(e.isUnreadable) || +e.isUnreadable == 1,
            isReplyMsg: i(e.isReplyMsg) || +e.isReplyMsg == 1,
            needPushNick: i(e.needPushNick) || +e.needPushNick == 1,
            needMsgReceipt: +e.needMsgReceipt == 1,
            isLocal: !1,
          };
          if (
            (o(e.isMuted) && (t.isMuted = +e.isMuted == 1),
            o(e.resend) && (t.resend = +e.resend == 1),
            o(e.idClient) && (t.idClient = e.idClient),
            o(e.idServer) && (t.idServer = `${e.idServer}`),
            o(e.userUpdateTime) && (t.userUpdateTime = +e.userUpdateTime),
            o(e.custom) && (t.custom = e.custom),
            o(e.pushContent) && (t.pushContent = e.pushContent),
            o(e.pushPayload) && (t.pushPayload = e.pushPayload),
            o(e.tempTeamMemberCount) && (t.tempTeamMemberCount = +e.tempTeamMemberCount),
            o(e.apnsAccounts))
          ) {
    ...
    function(e, t, n) {
      ...
      var s = {
        ...
        object2url(e) {
          ...
          const i = [];
          for (const o in s) o !== 'imageView' && i.push(`${o}=${encodeURIComponent(s[o])}`);
    ...
    function(e, t, n) {
      ...
      const p = new d({ configMap: o, serializeMap: a, unserializeMap: c });
      ...
      (d.getInstance = function(e) {
        ...
        (d.prototype.parseResponse = function(e) {
          ...
          const s = { raw: n, rawStr: e, error: i.genError(n.code) };

          let o = t.configMap.packetConfig[`${n.sid}_${n.cid}`];
          if (!o) return (s.notFound = { sid: n.sid, cid: n.cid }), s;
          let a = n.r;

          const c = o.service === 'notify' && !o.cmd;
          if (((s.isNotify = c), c)) {
          ...
          return (
            s.error &&
              o.trivialErrorCodes &&
              (d = o.trivialErrorCodes.indexOf(s.error.code) !== -1),
            (s.error && !d) ||
              !o.response ||
              ((s.content = {}),
              o.response.forEach((e, i) => {
                const o = a[i];
                if (!r.undef(o)) {
                  const u = e.type;
    ...
    function(e, t, n) {
      ...
      const i = r.fillPropertyWithDefault;

      const o = { 0: 'normal', 1: 'owner', 2: 'manager' };
      function a(e) {
    ...
    function(e, t, n) {
      ...
      e.exports.f = function(e) {
        return o && i.call(e) == '[object Window]'
          ? (function(e) {
              try {
                return s(e);
              } catch (e) {
    ...
    function(e, t, n) {
      ...
      const Y = function(e) {
        for (var t, n = A(M(e)), r = [], i = 0; n.length > i; )
          s(D, (t = n[i++])) || t == F || t == c || r.push(t);
        return r;
      };

      const Q = function(e) {
        for (var t, n = e === B, r = A(n ? L : M(e)), i = [], o = 0; r.length > o; )
      ...
      q ||
        ...
        (n(26).f = K),
        (n(33).f = Q),
        i && !n(20) && a(B, 'propertyIsEnumerable', K, !0),
        (f.f = function(e) {
          return J(p(e));
        })),
      ...
      for (
        ...
        p(Z[ee++]);
      for (let te = w(p.store), ne = 0; te.length > ne; ) g(te[ne++]);
      o(o.S + o.F * !q, 'Symbol', {
        for(e) {
    ...
    function(e, t, n) {
      ...
      function g(e) {
        s.verifyOptions(e, 'type to', 'sysmsg::SystemMessage'),
          ...
          e.type.indexOf('custom') !== -1 &&
            ...
            o(e.apnsText) && (this.apnsText = `${e.apnsText}`),
            o(e.pushPayload) &&
          ...
          (this.type = l[e.type]),
          (this.to = e.to),
          o(e.from) && (this.from = e.from),
          o(e.ps) && (this.ps = e.ps),
          o(e.deletedIdClient) && (this.deletedIdClient = e.deletedIdClient),
          o(e.deletedIdServer) && (this.deletedIdServer = e.deletedIdServer),
          o(e.opeAccount) && (this.opeAccount = e.opeAccount),
          o(e.yidunEnable) && (this.yidunEnable = e.yidunEnable ? 1 : 0),
          o(e.antiSpamContent) &&
            ((0, r.default)(e.antiSpamContent) === 'object'
              ? (this.logger.warn(
      ...
      (g.validTypes = Object.keys(l).concat(Object.keys(f))),
        ...
        (g.reverse = function(e) {
          ...
          if (
            (o(e.from) && (t.from = e.from),
            o(e.idServer) && (t.idServer = `${e.idServer}`),
            o(e.deletedIdClient) && (t.deletedIdClient = e.deletedIdClient),
            o(e.deletedIdServer) && (t.deletedIdServer = `${e.deletedIdServer}`),
            o(e.deletedMsgTime) && (t.deletedMsgTime = +e.deletedMsgTime),
            o(e.deletedMsgFromNick) && (t.deletedMsgFromNick = `${e.deletedMsgFromNick}`),
            o(e.opeAccount) && (t.opeAccount = e.opeAccount),
            o(e.ps) && (t.ps = e.ps),
            (e.attach = e.attach ? `${e.attach}` : ''),
            t.type === 'customP2p' || t.type === 'customTeam')
          )
            (t.content = e.attach),
              o(e.apnsText) && (t.apnsText = e.apnsText),
              o(e.pushPayload) && (t.pushPayload = e.pushPayload),
              s.merge(t, {
                sendToOnlineUsersOnly: i(e.sendToOnlineUsersOnly) || +e.sendToOnlineUsersOnly == 0,
                cc: i(e.cc) || +e.cc == 1,
                isPushable: i(e.isPushable) || +e.isPushable == 1,
                isUnreadable: i(e.isUnreadable) || +e.isUnreadable == 1,
            ...
            if (e.attach) {
              ...
              o(n.vt)
                ...
                : (o(n.tinfo) && (t.attach.team = c.reverse(a.unserialize(n.tinfo, 'team'))),
                  o(n.tlist) && (t.attach.member = u.reverse(a.unserialize(n.tlist, 'teamMember'))),
                  o(n.attach) && (t.attach.custom = n.attach));
            }
    ...
    function(e, t, n) {
      ...
      (c.updateCustomMode = { 0: 'manager', 1: 'all' }),
        ...
        (b.fillProperties = function(e) {
          const t = i(e, 'beInviteMode', 'needVerify');

          const n = i(e, 'inviteMode', 'manager');

          const r = i(e, 'updateTeamMode', 'manager');

          const s = i(e, 'updateCustomMode', 'manager');
    ...
    function(e, t, n) {
      ...
      const a = (o.prototype = Object.create(i.prototype));
      (a.send = function() {
        const e = this;
    ...
    function(e, t, n) {
      ...
      function d(e, t) {
        ...
        const i = t.method || '';
        return (
          (i && !/get/i.test(i)) || !t.data || ((e = m(e, t.data)), (t.data = null)),
          (t.url = e),
          (s.req = u(t)),
          n
        );
      ...
      (a.prototype = Object.create(s.prototype)),
        (a.reverse = function(e) {
          ...
          return (
            ...
            o.httpsEnabled && (t.file.url = t.file.url.replace('http', 'https')),
            t
          );
        }),
        (e.exports = a);
    ...
    function(e, t, n) {
      ...
      const i = { unknown: 0, male: 1, female: 2 };

      const o = { 0: 'unknown', 1: 'male', 2: 'female' };
      function a(e) {
        s.merge(this, e),
                ...
                (e.EventEmitter = n),
                  ...
                  (n.prototype.emit = function(e) {
                    ...
                    if (typeof n === 'function') n.apply(this, r);
                      ...
                      for (let s = n.slice(), i = 0, o = s.length; i < o; i++) s[i].apply(this, r);
                    }
                    return !0;
                  });
                ...
                (e.XHR = r),
                  ...
                  (r.check = function(e, r) {
                    try {
                      ...
                      const i = n.XDomainRequest && s instanceof XDomainRequest;

                      const o = e && e.options && e.options.secure ? 'https:' : 'http:';

                      const a = n.location && o != n.location.protocol;
                      if (s && (!i || !a)) return !0;
                    } catch (e) {}
                    return !1;
                  }),
    ...
    function(e, t) {
      e.exports = function e(t, n) {
        ...
        const m = l(t).replace(o, '') || '';

        const d = l(n).replace(o, '') || '';
    ...
    function(e, t, n) {
      ...
      function a(e, t, n) {
        let r = e;
        return (
          s(t) ? ((n = t), typeof e === 'string' && (r = { uri: e })) : (r = o(t, { uri: e })),
          (r.callback = n),
          r
        );
      }
    ...
    function(e, t, n) {
      ...
      const i = { addFriend: 1, applyFriend: 2, passFriendApply: 3, rejectFriendApply: 4 };

      const o = { 1: 'addFriend', 2: 'applyFriend', 3: 'passFriendApply', 4: 'rejectFriendApply' };
      function a(e) {
    ...
    function(e, t, n) {
      ...
      (s.login = function() {
        ...
        (s.onKicked = function(e) {
          ...
          if (
            (m(n) && (o.from = a.reverseType(n)),
            m(s) && (o.custom = s),
            this.shouldNotifyKicked(o))
          ) {
            const c = new i('被踢了', 'kicked');
            l.merge(c, o), this.onAuthError(c, 'link::onKicked');
          } else
    ...
    function(e, t, n) {
      ...
      function o(e, t, n, r) {
        ...
        if (
          (n === 1
            ...
            : n === 2 && (i = new RegExp(t, 'g')).test(e) && (s = !0),
          s && i !== '')
        )
          switch (r) {
            case 1:
      ...
      function a(e, t) {
        for (var n = t.match, s = t.operate, i = e, a = 0; a < t.keys.length; a++) {
          const c = t.keys[a];
          ...
          const l = c.operate || s;
          try {
            if ((void 0 === (i = o(i, c.key, u, l)) ? 'undefined' : (0, r.default)(i)) === 'object')
              return i;
          } catch (e) {
      ...
      (i.uploadSdkLogUrl = function(e) {
        ...
        (i.getClientAntispamLexicon = function(e) {
          ...
          const r = this;
          return this.protocol.sendCmd('getClientAntispam', e, (e, s, i) => {
            e
        ...
        (i.filterClientAntispam = function(e) {
          ...
          for (var i = t, o = 0; o < s.length; o++)
            if (
              (void 0 === (i = a.call(this, i, s[o])) ? 'undefined' : (0, r.default)(i)) ===
              'object'
            ) {
              if (i.code === 2)
    ...
    function(e, t, n) {
      ...
      const o = n(46).fn;
      (o.viewImageSync = function(e) {
        const t = this.options;
        i.verifyOptions(e, 'url', 'nos::viewImageSync');
        const n = e.url;

        const o = (0, s.url2object)(n);
        ...
        (o.viewImageStripMeta = function(e) {
    ...
    function(e, t, n) {
      ...
      (s.getSimpleNosToken = function() {
        ...
        (s.genCropOp = function(e) {
          ...
          const o = Math.round(e.height);
          return new i({ type: e.type, cropX: t, cropY: n, cropWidth: s, cropHeight: o });
        }),
    ...
    function(e, t, n) {
      ...
      function u(e) {
        ...
        if (a)
          if (o) {
            const u = e.type ? r.filterFiles(o.files, e.type) : [].slice.call(o.files, 0);
            if (!u || !u.length)
            ...
            (i =
              typeof (r = function(e) {
                return function(t) {
                  ...
                  function i(e, n, r) {
                    ...
                    if (!(e[n] instanceof Array) && t.arrayAccessFormPaths.length > 0) {
                      for (var s = !1, i = 0; i < t.arrayAccessFormPaths.length; i++) {
                        const o = t.arrayAccessFormPaths[i];
                        if (typeof o === 'string') {
                          if (o === r) {
                            s = !0;
                            break;
                        ...
                        } else if (typeof o === 'function' && o(n, r)) {
                          s = !0;
                          break;
                        }
                      }
                  ...
                  function a(e, s) {
                    for (var a = { __cnt: 0 }, u = e.childNodes, l = 0; l < u.length; l++) {
                      ...
                      m.nodeType !== n.COMMENT_NODE &&
                        (a.__cnt++,
                        a[d] == null
                          ? ((a[d] = c(m, `${s}.${d}`)), i(a, d, `${s}.${d}`))
                          : (a[d] instanceof Array || ((a[d] = [a[d]]), i(a, d, `${s}.${d}`)),
                        ...
                        (a.__text = (function(e, n, r) {
                          if (t.datetimeAccessFormPaths.length > 0)
                            for (
                              ...
                              } else if (typeof a === 'function' && a(s)) return o(e);
                            }
                          return e;
                        })(a.__text, 0, `${s}.#text`))),
                  ...
                  function u(e, n, r, i) {
                    let o = `<${e && e.__prefix ? `${e.__prefix}:` : ''}${n}`;
                    if (r)
    ...
    function(e, t, n) {
      ...
      (s.sendText = function(e) {
        ...
        (s._doPreviewFile = function(e) {
          ...
          const o = this.assembleUploadParams(e.nosToken);
          function m(r, s) {
            if (((e.uploaddone = n), r)) e.done(r, e.callback.options);
              ...
              (s.size = s.size || 0), e.done(null, i.copy(s));
            }
          }
          if (c.isWeixinApp)
            ...
            l.uploadFile(p);
          } else (e.uploaddone = m), (e.url = s), (e.params = o), (e.fileName = 'file'), new l(e);
        }),
        ...
        (s.sendMsg = function(e) {
          ...
          let o = (e.rtnMsg = this.formatReturnMsg(n));
          return (
            s && ((o.status = 'success'), (o.isLocal = !0)),
            t.storeSendMsg && (r.promise = t.storeSendMsg(o)),
            (e.cbaop = function(e) {
              if (e && e.from !== 'server')
                return (o.status = 'fail'), t.updateSendMsgError && t.updateSendMsgError(o), o;
            }),
      ...
      const i = (function() {
        ...
        return function(n, i) {
          ...
          return (
            ...
            t.test(i.method) && e.test(u) && (i.data = JSON.stringify(o)),
            s(n, i)
          );
        };
      })();
    ...
    function(e, t, n) {
      ...
      (l.init = (function() {
        ...
        function t(e) {
          let t = e.data;
          if (t.indexOf(o) === 0) {
            const n = (t = JSON.parse(t.replace(o, ''))).key;
 ...
 */ !(function(
        ...
        (i.getListeners = function(e) {
          ...
          (i.manipulateListeners = function(e, t, n) {
            ...
            const o = e ? this.removeListeners : this.addListeners;
            if (typeof t !== 'object' || t instanceof RegExp)
              ...
              for (r in t)
                t.hasOwnProperty(r) &&
                  (s = t[r]) &&
                  (typeof s === 'function' ? i.call(this, r, s) : o.call(this, r, s));
            return this;
          }),
    ...
    function(e, t, n) {
      ...
      const a = (i.prototype = Object.create(o));
      (a.doSend = function() {
        const e = this.options;
 ...
 */
        !(function(t, n) {
          ...
          function y(e, t) {
            ...
            const s = n._state;
            if (s) {
              const i = arguments[s - 1];
              a(() => {
                return R(s, r, i, n._result);
              });
            } else _(n, r, e, t);
            return r;
          }
          ...
          function E(e) {
            ...
            const n = e._state;
            if (t.length !== 0) {
              for (let r = void 0, s = void 0, i = e._result, o = 0; o < t.length; o += 3)
                (r = t[o]), (s = t[o + n]), r ? R(n, r, s, i) : s(i);
          ...
          function R(t, n, r, s) {
            ...
            n._state !== T ||
              (i && c ? w(n, o) : u ? A(n, a) : t === k ? x(n, o) : t === S && A(n, o));
          }
          let F = 0;
          function j(e) {
              ...
              (e.prototype._eachEntry = function(e, t) {
                ...
                if (r === v) {
                  ...
                  if (s === y && e._state !== T) this._settledAt(e._state, t, e._result);
                    ...
                    const i = new n(M);
                    I(i, e, s), this._willSettleAt(i, t);
                  } else
                    this._willSettleAt(
                      new n(t => {
                        return t(e);
          ...
          return (
            ...
            (N.race = function(e) {
              ...
              return r(e)
                ? new t((n, r) => {
                    for (let s = e.length, i = 0; i < s; i++) t.resolve(e[i]).then(n, r);
                  })
                : new t((e, t) => {
    ...
    function(e, t, n) {
      ...
      (s.batchSendEventsCmds = function(e, t, n) {
        ...
        let s = i.dropArrayDuplicates(t.accounts);

        const o = [];
        (s = i.reshape2d(s, 100)).forEach(n => {
          o.push(
            new Promise((s, o) => {
              const a = i.simpleClone(t);
              (a.accounts = n),
        ...
        (s.subscribeEvent = function(e) {
          ...
          let t = new a(e);
          i.verifyParamType('accounts', e.accounts, 'array', 'event::subscribeEvent'),
            this.processCallback(e),
            (t = t.assembleEvent()),
        ...
        (s.unSubscribeEventsByAccounts = function(e) {
          i.verifyOptions(e, 'accounts', 'event::unSubscribeEventsByAccounts'),
            i.verifyParamType(
              'accounts',
              e.accounts,
              'array',
        ...
        (s.querySubscribeEventsByAccounts = function(e) {
          i.verifyOptions(e, 'accounts', 'event::querySubscribeEventsByAccounts'),
            i.verifyParamType(
              'accounts',
              e.accounts,
              'array',
      ...
      (r.markSysMsgRead = function(e) {
        ...
        (r.updateLocalSysMsg = function(e) {
          ...
          if (
            ...
            const i = s.filterObj(e, 'idServer state localCustom');
      ...
      (r.getHistoryMsgs = function(e) {
        ...
        (r.updateLocalMsg = function(e) {
          ...
          if (
            ...
            const i = s.filterObj(e, 'idClient localCustom');
            n.updateMsg(i).then(
              e => {
                (r = e), o();
              },
    ...
    function(e, t, n) {
      ...
      (r.setCurrSession = function(e) {
        ...
        (r.updateLocalSession = function(e) {
          ...
          let i = s.filterObj(e, 'id localCustom');
          function o() {
    ...
    function(e, t, n) {
      ...
      (r.friendRequest = function(e) {
        s.verifyOptions(e, 'type account', 'friend::friendRequest'),
          ...
          this.processPs(e),
          this.processCallback(e);
        const t = { account: e.account, type: o.getByteFromType(e.type), ps: e.ps };
    ...
    function(e, t, n) {
      ...
      (r.mergeObjArray = function(e, t, n) {
        return (
          e || (e = []),
          t ? (i(t) || (t = [t]), t.length ? ((n = n || {}), s.mergeObjArray(e, t, n)) : e) : e
        );
      }),
        (r.cutObjArray = function(e, t, n) {
          return e && t
            ? (i(t) || (t = [t]), t.length ? ((n = n || {}), s.cutObjArray(e, t, n)) : e)
            : e;
        }),
        ...
        (r.cutTeamMembersByAccounts = function(e, t, n) {
          i(n) || (n = [n]);
          const r = o.assembleMembers({ teamId: t }, n);
    ...
    function(e, t, n) {
      ...
      const o = { '01': 'text', '02': 'image', '03': 'answer', 11: 'template' };
      function a(e) {
        ...
        (a.reverse = function(e) {
          ...
          if (t.type === 'robot') {
            ...
            if ((n.param && (n.param.type = o[n.param.type] || 'unknown'), n.robotMsg)) {
              const i = (n = s.merge(n, n.robotMsg)).message;
              n.flag === 'bot'
                ? (n.message = i.map(e => {
        ...
        (u.reverse = function(e) {
          ...
          if (((e.attach = e.attach ? `${e.attach}` : ''), e.attach)) {
            ...
            if (((t.attach = { type: c[n.id] || n.id }), r(n.data))) {
              const u = n.data;
              r(u.tinfo) && (t.attach.team = o.reverse(i.unserialize(u.tinfo, 'team'), !0)),
    ...
    function(e, t, n) {
      ...
      const o = (i.Message = n(66));

      const a = (i.TextMessage = n(314));

      const c = (i.FileMessage = n(117));

      const u = (i.GeoMessage = n(310));

      const l = (i.NotificationMessage = n(309));

      const m = (i.CustomMessage = n(308));

      const d = (i.TipMessage = n(307));

      const p = (i.RobotMessage = n(306));
    ...
    function(e, t, n) {
      ...
      const o = r.default.clientTypeMap;
      function a(e) {
        e = e || {};
        const t = i.copy(e);
        return (
          t.clientType && (t.clientType = o[t.clientType] || ''),
          t.serverCustom &&
      ...
      (r.syncSessionAck = function(e) {
        ...
        (r.markUnreadBySessionAck = function(e) {
          ...
          if (s.enable)
            ...
            const i = r.findSession(t);
            if (i) {
              const o = i.unreadMsgs;
              if (o && o.length) {
        ...
        (r.updateLocalSession = function(e, t) {
          ...
          return new Promise((r, i) => {
            ...
            if (n.findSession(e.id)) {
              ...
              i(o.sessionNotExist({ sessionId: e.id, callFunc: 'session::updateLocalSession' }));
          });
        });
    },
    function(e, t, n) {
      ...
      (r.splitSysMsgs = function(e, t) {
        ...
        (r.onOfflineSysMsgs = function(e, t) {
          ...
          const s = [];
          n.splitSysMsgs(r, s);
          const o = t ? 'offlineFilterSysMsgs' : 'offlineSysMsgs';
        ...
        (r.onSysMsg = function(e, t) {
          const n = i.reverse(e.content.sysMsg);
      ...
      (r.onDeleteMsg = function(e) {
        ...
        (r.onDeleteMsgOfflineRoaming = function(e) {
          if (!e.error) {
            ...
            const i = e.content.timetag;
            (t.timetags.deleteMsg = i), (t.syncResult.deleteMsgTimetag = i);
            const o = t.putSysMsg(r, 'offlineSysMsgs');
              ...
              e.sysMsgs.forEach(e => {
                const a = n.deleteLocalMsg(e.msg, {
                  cbUpdateSession(e) {
                    ...
                    const s = o.findObjIndexInArray(t, { value: e.id });
                    if ((s !== -1 && (t[s] = o.merge({}, t[s], e)), r.enable))
    ...
    function(e, t, n) {
      ...
      (r.onOfflineMsgReceipts = function(e) {
        ...
        const i = (n.syncResult.msgReceipts = []);
          ...
          r.enable
            ? (t = r.getSession(s).then(t => {
                if ((t = t || u) && n.shouldUpdateSessionFromMsgReceipt(t, e)) {
                  const i = n.genSessionFromMsgReceipt(t, e);

                  let o = n.syncResult.sessions;
                  return (
                    o &&
                      o[s] &&
                      (o = o[s]).lastMsg &&
                      i.lastMsg &&
                      o.lastMsg.time > i.lastMsg.time &&
                      (i.lastMsg = o.lastMsg),
                    r.putSession(i).then(e => {
          ...
          return (
            ...
            t.forEach(t => {
              ...
              if (n.shouldUpdateSessionFromMsgReceipt(s, t)) {
                const i = n.genSessionFromMsgReceipt(s, t);
    ...
    function(e, t, n) {
      ...
      (r.processMsg = function(e) {
        ...
        (r.onRoamingMsgs = function(e) {
          ...
          let i = n.reverseMsgs(e.content.msgs);

          const o = s(i);
          i = r.sortMsgs(i);
          const a = (i = r.deduplication(i))[0];

          const c = a.sessionId;

          const u = t.genSessionByMsgs(i);
          t.cacheSyncedSession(u);
          const l = t.putMsg(i, 'roamingMsgs').then(e => {
            (i = e),
        ...
        (r.onOfflineMsgs = function(e, t) {
          ...
          const c = r.reverseMsgs(e.content.msgs, { modifyObj: i });
                ...
                ((a = n.putMsg(u, 'offlineMsgs').then(s => {
                  (u = s),
                    (u = n.filterIgnore(u)).length &&
                      ...
                      n.syncResult[m].push({ sessionId: e, scene: r, to: i, msgs: u, timetag: t }));
                })).cmd = `offlineMsgs-${e}`),
            ...
            (a = (a = (a = a
              ...
              if (m && p.length) {
                ...
                if (t === 'offlineMsgs' || (s && a) || (t === 'onMsg' && u === 'in' && l)) {
                  o && e ? ((m = e), (h = h || m.ack || 0)) : (e = g) && (m.unread = e.unread || 0),
                    f(m),
                    (m.unread = m.unread || 0);
                  let y = 0;
                  if (
                    (p.forEach(e => {
                      ...
                      if ((r && a && (r = e.time > h && e.flow !== 'out'), r && (y++, a && !o))) {
          ...
          return (
            ...
            t.enable
              ? t.updateMsg(e).then(e => {
                  const i = t.updateSession(r);

                  let o = Promise.resolve();
                  return (
                    n && e && !s && (o = t.updateRoamingMsgTimetag(e.time)), Promise.all([i, o])
                  );
                })
        ...
        (r.onRemoveTeamMembers = function(e, t, n) {
          ...
          if (
            ...
            if (n.indexOf(this.account) === -1) {
              const o = r.removeTeamMembersByAccounts(t, n);
        ...
        (r.updateTeamManagers = function(e, t, n, r, i) {
          ...
          const u = { teamId: `${t}`, memberUpdateTime: i };
          e.attach.team = u;
          ...
          if (
            ...
            const m = o.updateTeam(u);

            const d = o.updateTeamManagers(t, n, r, i);
        ...
        (r.transferTeam = function(e, t, n, r) {
          ...
          const u = { id: a.genId(o, n), type: 'normal', updateTime: c };

          const l = { id: a.genId(o, r), type: 'owner', updateTime: c };
      ...
      (r.processNotify = function(e) {
        ...
        (r.onDonnop = function(e, t) {
          if (!e.error) {
            ...
            const s = i.reverse(e.content.donnop);
            n.mergeDonnop(s);
            let o = n.dbDonnop();
            if (t) {
    ...
    function(e, t, n) {
      ...
      (r.processTeam = function(e) {
        ...
        switch (e.cmd) {
          case 'createTeam':
            if (
              ...
              const i = { team: n, owner: s };
              this.logger.info('team::processTeam: create team', i),
                this.options.onCreateTeam(i),
          ...
          const m = new Promise((m, p) => {
            e.error
              ...
              : ((function() {
                  ...
                  n.logger.info('team::onTeams: parseData', o(u), u, 'invalid', o(l), l),
          ...
          const m = new Promise((m, d) => {
            e.error
              ...
              : (!(function() {
                  ...
                  r.logger.warn('team::onTeamMembers: parseData', n, i(u), u, 'invalid', i(l), l),
        ...
        (r.notifyForNewTeamMsg = function(e) {
          ...
          return (
            i.length &&
              (o = t.api.getMyTeamMembers({ teamIds: i, promise: !0 }).then(e => {
                return (
    ...
    function(e, t, n) {
      ...
      (r.processFriend = function(e) {
          ...
          const d = new Promise((d, f) => {
            s
              ...
              : ((function() {
                  ...
                  n.logger.info('friend::onFriends: parse friends', i(l), l, 'delete', i(m), m),
                    c.length ? ((u = !0), (t = e.content.timetag)) : (u = !1);
                })(),
                r.enable
                  ? (function(s, i) {
                      e.promise = new Promise((e, o) => {
                        function c() {
                          a
                            ? (p(), e(), s())
                            : r
                                ...
                                .then(void 0, e => {
                                  (e._msg = 'get friends error'), o(e), i(e);
                                });
                        }
                        u
                          ? r
                              ...
                              .then(void 0, e => {
                                (e._msg = 'merge friends error'), o(e), i(e);
                              })
                          : (n.logger.info('friend::onFriends: no merge friends'), c());
                      }).then(void 0, e => {
                        throw ((e._msg = 'merge friends data error'), i(e), e);
                      });
                    })(d, f)
                  : (p(), d()));
          });
        ...
        (r.onFriendRequest = function(e, t) {
          ...
          let s = e.type;
          if ((s = e.type = o.getTypeFromByte(s) || s) === 'addFriend' || s === 'passFriendApply') {
            const i = (e.friend = o.assembleFriend(e.account));
      ...
      (s.beforeSync = function() {
        ...
        (s.syncData = function() {
          ...
          function s(t) {
            (e.syncPromiseArray = []),
              ...
              i.verifyBooleanWithDefault(n, 'syncFilter syncTeamMembers', !1, '', 'sync::syncData');
            const r = {};
            (t = t || {}),
              d._nimForceSyncIM &&
        ...
        (s.onSyncDone = function(e) {
          ...
          function L() {
            if (j) {
              if (
                (_.logger.info('sync::onSyncDone: after sync', i.promises2cmds(j)),
                (j = []),
                (n = U.blacklist || []),
                ...
                (k = U.roamingMsgs),
                (S = U.offlineMsgs),
                (P = U.offlineFilterMsgs),
                (I = U.offlineSysMsgs),
                (w = U.offlineCustomSysMsgs),
                (O = U.offlineFilterSysMsgs),
          ...
          function H() {
            ...
            U.deleteMsgSysMsgs &&
              U.deleteMsgSysMsgs.forEach(e => {
                e.type === 'roaming' ? (s = s.concat(e.sysMsgs)) : (o = o.concat(e.sysMsgs));
              }),
              s.length && (C = (C = C || []).concat(s)),
              o.length && (I = (I = I || []).concat(o)),
              C &&
                (_.logger.info('sync::notifyDataAsync: on roaming sys msgs', C.length, C),
                F.onroamingsysmsgs(C)),
              I &&
                (_.logger.info('sync::notifyDataAsync: on offline sys msgs', I.length, I),
                F.onofflinesysmsgs(I)),
              O &&
                (_.logger.info('sync::notifyDataAsync: on offline filter sys msgs', O.length, O),
                F.onofflinefiltersysmsgs(O)),
              w &&
                (_.logger.info('sync::notifyDataAsync: on offline custom sys msgs', w.length, w),
                F.onofflinecustomsysmsgs(w)),
              x &&
                (_.logger.info(
              ...
              A &&
                ((A = i.merge({}, _.sysMsgUnread, A)),
                (_.sysMsgUnread = i.merge({}, A)),
          ...
          function W() {
            if (
              ...
              throw new o('sync team members api deprecated!');
          }
        }),
        ...
        (s.onSyncTeamMembersDone = function() {
          ...
          let o = t.syncTeamMembersPromiseArray;
          function a() {
            t.logger.log('sync::onSyncTeamMembersDone: afterSync', i.promises2cmds(o)),
              (o = []),
    ...
    function(e, t, n) {
      ...
      r.refreshSocketUrl = function() {
        ...
        (r = `${r + i.genUrlSep(r)}k=${t.appKey}&id=${t.account}&sv=${n.sdkVersion}&pv=${
          n.protocolVersion
        }`),
      ...
      (r.putSysMsg = function(e) {
        ...
        (r.markSysMsgRead = function(e) {
          ...
          return new Promise((n, r) => {
            ...
            const c = [];
            e.forEach(e => {
              (i = t.getSysMsgByIdServer(e.idServer).then(e => {
                e &&
                  !e.read &&
        ...
        (r.getMsgsIndexedDB = function(e) {
          ...
          s.exist(i)
            ...
            : s.exist(o) &&
              ...
              s.isString(o)
                ? ((t = 'sessionTime'), (i = o))
                : Array.isArray(o) &&
                  (o.length === 1 ? ((t = 'sessionTime'), (i = o[0])) : (r = !0)));
          const a = e.start || 0;
          ...
          return (
            (r || p || y || s.isFunction(v)) &&
              (b = function(e) {
                if (r && o.indexOf(e.sessionId) === -1) return !1;
                if (p)
                  if (f) {
    ...
    function(e, t, n) {
      ...
      (r.mergeTeams = function(e, t, n) {
        ...
        (r.transferTeam = function(e, t, n) {
          ...
          const i = e.memberUpdateTime;

          const o = { teamId: s, account: t, type: 'normal', updateTime: i };

          const a = { teamId: s, account: n, type: 'owner', updateTime: i };
          return r.updateTeamMembers([o, a]).then(() => {
        ...
        (r.mergeTeamMembers = function(e, t, n, r) {
          ...
          const i = s.putTeamMembers(t);

          const o = s.updateTeamMembers(n);
          return Promise.all([i, o]).then(() => {
        ...
        (r.updateTeamMember = function(e) {
          ...
          const o = s.filterObj(e, 'nickInTeam muteTeam mute custom updateTime type valid');
          return this.getOne('teamMember', null, i, { modifyObj: o, mapper: l }).then(e => {
            return (
              e
    ...
    function(e, t, n) {
      ...
      (r.mergeRelations = function(e, t, n, r, s) {
        ...
        const o = i.updateAndDelete('blacklist', e, t);

        const a = i.updateAndDelete('mutelist', n, r);
        return Promise.all([o, a]).then(() => {
          return (
    ...
    function(e, t, n) {
      (function(r) {
        ...
        !(function(o, a) {
          ...
          const u =
            (o = void 0 !== o ? o : typeof self !== 'undefined' ? self : void 0 !== r ? r : {})
              .IDBKeyRange || o.webkitIDBKeyRange;
          ...
          const p = function() {
            if (
              ...
              !(c =
                ...
                o.oIndexedDB ||
                o.msIndexedDB ||
                (o.indexedDB === null && o.shimIndexedDB ? o.shimIndexedDB : void 0))
            )
          ...
          const v = function(e, t) {
              ...
              (this.add = function(t) {
                ...
                for (var s = [], i = 0, o = 0; o < arguments.length - 1; o++)
                  if (Array.isArray(arguments[o + 1]))
                    for (let a = 0; a < arguments[o + 1].length; a++)
            ...
            for (let s = 0, i = e.objectStoreNames.length; s < i; s++)
              !(function(e) {
          ...
          var b = function(e, t, n) {
            ...
            const a = function(r, a, c, d, p, f, g) {
              return new Promise((y, v) => {
                ...
                const P = [r ? u[r].apply(null, a) : null];

                let C = 0;
                (p = p || null), (f = f || []), c !== 'count' && P.push(d || 'next');
                const I = !!s && Object.keys(s);
                (k[c](...P).onsuccess = function(e) {
                  const t = e.target.result;
                  if ((void 0 === t ? 'undefined' : (0, i.default)(t)) === (0, i.default)(0)) S = t;
                  else if (t)
                    if (p !== null && p[0] > C) (C = p[0]), t.advance(p[0]);
                    else if (p !== null && C >= p[0] + p[1]);
                    else {
                      let n = !0;
          ...
          const k = {
            ...
            remove(e) {
              return new Promise((t, n) => {
                ...
                let r;
                let s;
                (void 0 === e ? 'undefined' : (0, i.default)(e)) === v && (e = e.name),
    ...
    function(e, t, n) {
      ...
      (g.reset = a.emptyFunc),
        ...
        (g.modifyOrPut = function(e) {
          ...
          const i = e.modifyObjWhenPut;

          const o = a.copy(r);
          return (
            delete o[s],
            t.getOne(n, null, r[s], { modifyObj: o }).then(e => {
              return e
